...
class ConsumerOfTheLastMember {
 public:
  void go() { ClassWithHiddenMembers::this_last_member.consume(); }

  void on() { ClassWithHiddenMembers::this_last_member.consume(); }
  //------------------------------------------------------------------------------
  //
  // 6 - FOCUSING EDGES
  ...
  //
  //------------------------------------------------------------------------------
  void reading() { ClassWithHiddenMembers::this_last_member.consume(); }
};
