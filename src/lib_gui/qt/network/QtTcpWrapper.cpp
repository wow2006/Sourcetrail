...
quint16 QtTcpWrapper::getServerPort() const { return m_serverPort; }

void QtTcpWrapper::setServerPort(const quint16 serverPort) { m_serverPort = serverPort; }

quint16 QtTcpWrapper::getClientPort() const { return m_clientPort; }

void QtTcpWrapper::setClientPort(const quint16 clientPort) { m_clientPort = clientPort; }

bool QtTcpWrapper::isListening() const { return m_tcpServer->isListening(); }
