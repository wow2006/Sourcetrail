...
class QtThreadedFunctor {
 public:
  ...
  void operator()(T1 p1, T2 p2, T3 p3, T4 p4) { m_helper(std::bind(m_callback, p1, p2, p3, p4)); }
...
class QtThreadedFunctor<T1, T2, T3, void> {
 public:
  ...
  void operator()(T1 p1, T2 p2, T3 p3) { m_helper(std::bind(m_callback, p1, p2, p3)); }
...
class QtThreadedFunctor<T1, T2, void, void> {
 public:
  ...
  void operator()(T1 p1, T2 p2) { m_helper(std::bind(m_callback, p1, p2)); }
...
class QtThreadedFunctor<T1, void, void, void> {
 public:
  ...
  void operator()(T1 p1) { m_helper(std::bind(m_callback, p1)); }
...
class QtThreadedFunctor<void, void, void, void> {
 public:
  ...
  void operator()() { m_helper(m_callback); }
...
class QtThreadedLambdaFunctor {
 public:
  void operator()(std::function<void(void)> callback) { m_helper(callback); }
