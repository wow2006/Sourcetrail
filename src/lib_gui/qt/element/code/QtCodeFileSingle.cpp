...
void QtCodeFileSingle::scrollTo(const FilePath& filePath, size_t lineNumber, Id locationId, Id scopeLocationId,
  ...
  if (focusTarget && locationId) {
    m_navigator->setFocusedLocationId(m_area, lineNumber, m_area->getColumnNumberForLocationId(locationId), locationId,
                                      {}, false, false);
  }
}
...
const FilePath& QtCodeFileSingle::getCurrentFilePath() const { return m_currentFilePath; }
