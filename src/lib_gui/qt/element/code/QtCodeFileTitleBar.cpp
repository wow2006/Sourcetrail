...
QtCodeFileTitleBar::QtCodeFileTitleBar(QWidget* parent, bool isHovering, bool isSingle) : QtHoverButton(parent) {
  ...
  m_collapseButton = new QtSelfRefreshIconButton(QLatin1String(""), imageDir.getConcatenated(L"snippet_arrow_down.png"),
                                                 "code/file/title", this);
  ...
  m_snippetButton->addState(QtIconStateButton::STATE_HOVERED, imageDir.getConcatenated(L"snippet_inactive.png"),
                            inactiveColor);
  ...
  m_maximizeButton->addState(QtIconStateButton::STATE_HOVERED, imageDir.getConcatenated(L"maximize_inactive.png"),
                             inactiveColor);
...
QtCodeFileTitleButton* QtCodeFileTitleBar::getTitleButton() const { return m_titleButton; }
...
void QtCodeFileTitleBar::setIsIndexed(bool isIndexed) { m_titleButton->setIsIndexed(isIndexed); }
...
bool QtCodeFileTitleBar::isCollapsed() const { return m_expandButton->isVisible(); }
...
void QtCodeFileTitleBar::clickedExpandButton() { emit snippet(); }

void QtCodeFileTitleBar::clickedCollapseButton() { emit minimize(); }

void QtCodeFileTitleBar::clickedSnippetButton() { emit snippet(); }

void QtCodeFileTitleBar::clickedMaximizeButton() { emit maximize(); }
