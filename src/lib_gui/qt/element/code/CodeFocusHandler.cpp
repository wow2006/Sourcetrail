...
bool CodeFocusHandler::isFocused() const { return m_hasFocus; }
...
const CodeFocusHandler::Focus& CodeFocusHandler::getCurrentFocus() const { return m_focus; }
...
void CodeFocusHandler::setFocusedLocationId(QtCodeArea* area, size_t lineNumber, size_t columnNumber, Id locationId,
                                            const std::vector<Id>& tokenIds, bool updateTargetColumn, bool fromMouse) {
...
size_t CodeFocusHandler::getTargetColumn() const { return m_targetColumn; }
