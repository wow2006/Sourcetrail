...
QtStringListBox::QtStringListBox(QWidget* parent, const QString& listName) : QtListBox(parent, listName) {}
...
QtListBoxItem* QtStringListBox::createListBoxItem(QListWidgetItem* item) { return new QtStringListBoxItem(this, item); }
