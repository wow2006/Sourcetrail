...
void QtBookmarkCategory::setName(const std::wstring& name) { m_name->setText(QString::fromStdWString(name)); }

std::wstring QtBookmarkCategory::getName() const { return m_name->text().toStdWString(); }

void QtBookmarkCategory::setId(const Id id) { m_id = id; }

Id QtBookmarkCategory::getId() const { return m_id; }

void QtBookmarkCategory::setTreeWidgetItem(QTreeWidgetItem* treeItem) { m_treeItem = treeItem; }
...
void QtBookmarkCategory::enterEvent(QEvent* event) { m_deleteButton->show(); }

void QtBookmarkCategory::leaveEvent(QEvent* event) { m_deleteButton->hide(); }
