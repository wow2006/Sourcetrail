...
QtSelfRefreshIconButton::QtSelfRefreshIconButton(const QString& text, const FilePath& iconPath,
                                                 const std::string& buttonKey, QWidget* parent)
...
void QtSelfRefreshIconButton::setAutoElide(bool autoElide) { m_autoElide = autoElide; }
