...
void QtHelpButton::setMessageBoxParent(QWidget* messageBoxParent) { m_messageBoxParent = messageBoxParent; }

void QtHelpButton::handleHelpPress() { m_info.displayMessage(m_messageBoxParent); }
