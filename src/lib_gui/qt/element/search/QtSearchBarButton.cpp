...
QtSearchBarButton::QtSearchBarButton(const utility::file::FilePath& iconPath, bool isSmall, QWidget* parent)
    : QtSelfRefreshIconButton(QLatin1String(""), iconPath, "search/button", parent)
    , m_small(isSmall) {
	refresh();
}
