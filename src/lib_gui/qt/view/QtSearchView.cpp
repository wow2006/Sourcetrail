...
void QtSearchView::createWidgetWrapper() { setWidgetWrapper(std::make_shared<QtViewWidgetWrapper>(m_widget)); }
...
std::wstring QtSearchView::getQuery() const { return m_widget->query().toStdWString(); }
