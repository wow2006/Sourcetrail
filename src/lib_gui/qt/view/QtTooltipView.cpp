...
void QtTooltipView::createWidgetWrapper() { setWidgetWrapper(std::make_shared<QtViewWidgetWrapper>(m_widget)); }
...
bool QtTooltipView::tooltipVisible() const { return m_widget->isVisible(); }
