...
class QtCustomTrailView : public QWidget, public CustomTrailView {
 public:
 ...
 private:
  ...
  QVBoxLayout* addFilters(const QString& name, const std::vector<QString>& filters, const std::vector<QColor>& colors,
                          std::vector<QCheckBox*>* checkBoxes, size_t filtersInFirstColumn);
