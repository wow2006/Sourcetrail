...
void QtCustomTrailView::setAvailableNodeAndEdgeTypes(NodeKindMask nodeTypes,
...
void QtCustomTrailView::showAutocompletions(const std::vector<SearchMatch>& autocompletions,
                                            bool from) {
