...
QtCustomTrailView::QtCustomTrailView(ViewLayout* viewLayout)
  ...
  // node filters
  {
    ...
    const std::vector<NodeKind> nodeKinds = {// NODE_SYMBOL,
                                             NODE_TYPE, NODE_BUILTIN_TYPE,
                                             // NODE_MODULE,
                                             // NODE_NAMESPACE,
                                             // NODE_PACKAGE,
                                             NODE_CLASS, NODE_STRUCT, NODE_UNION, NODE_INTERFACE, NODE_TYPEDEF,
                                             NODE_TYPE_PARAMETER, NODE_ENUM, NODE_ENUM_CONSTANT, NODE_GLOBAL_VARIABLE,
                                             NODE_FIELD, NODE_FUNCTION, NODE_METHOD, NODE_FILE, NODE_MACRO,
                                             NODE_ANNOTATION};
  ...
  // edge filters
  {
    ...
    std::vector<Edge::EdgeType> edgeTypes = {
        // Edge::EDGE_UNDEFINED,
        Edge::EDGE_TYPE_USAGE, Edge::EDGE_INHERITANCE, Edge::EDGE_USAGE, Edge::EDGE_CALL, Edge::EDGE_OVERRIDE,
        ...
        Edge::EDGE_TYPE_ARGUMENT, Edge::EDGE_INCLUDE, Edge::EDGE_IMPORT,
  ...
  // controls
  {
    ...
    connect(searchButton, &QPushButton::clicked, [this]() {
      ...
      MessageActivateTrail message(startId, endId, nodeTypes, edgeTypes, m_nodeNonIndexed->isChecked(),
...
QVBoxLayout* QtCustomTrailView::addFilters(const QString& name, const std::vector<QString>& filters,
                                           const std::vector<QColor>& colors, std::vector<QCheckBox*>* checkBoxes,
...
void QtCustomTrailView::setError(const QString& error) { m_errorLabel->setText(error); }
