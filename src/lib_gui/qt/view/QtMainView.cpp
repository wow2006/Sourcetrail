...
QtMainWindow* QtMainView::getMainWindow() const { return m_window; }
...
void QtMainView::overrideView(View* view) { m_window->overrideView(view); }
...
View* QtMainView::findFloatingView(const std::string& name) const { return m_window->findFloatingView(name); }
...
void QtMainView::loadLayout() { m_window->loadLayout(); }

void QtMainView::saveLayout() { m_window->saveLayout(); }
...
QStatusBar* QtMainView::getStatusBar() { return m_window->statusBar(); }

void QtMainView::setStatusBar(QStatusBar* statusbar) { m_window->setStatusBar(statusbar); }
...
void QtMainView::clearBookmarksMenu() { updateBookmarksMenu({}); }
