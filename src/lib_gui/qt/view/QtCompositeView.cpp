...
void QtCompositeView::createWidgetWrapper() { setWidgetWrapper(std::make_shared<QtViewWidgetWrapper>(m_widget)); }
...
void QtCompositeView::addViewWidget(View* view) { m_layout->addWidget(QtViewWidgetWrapper::getWidgetOfView(view)); }
