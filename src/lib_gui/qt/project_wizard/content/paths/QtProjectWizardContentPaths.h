...
class QtProjectWizardContentPaths : public QtProjectWizardContent {
 ...
 public:
  QtProjectWizardContentPaths(std::shared_ptr<SourceGroupSettings> settings, QtProjectWizardWindow* window,
                              QtPathListBox::SelectionPolicyType selectionPolicy, bool checkMissingPaths);
