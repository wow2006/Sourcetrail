...
QtProjectWizardContentPathsFrameworkSearchGlobal::QtProjectWizardContentPathsFrameworkSearchGlobal(
    ...
    : QtProjectWizardContentPaths(std::shared_ptr<SourceGroupSettings>(), window,
                                  QtPathListBox::SELECTION_POLICY_DIRECTORIES_ONLY, true) {
  setTitleString(QStringLiteral("Global Framework Search Paths"));
  setHelpString(
      QString::fromStdString("The Global Framework Search Paths will be used in all your projects - in addition to the "
                             "project specific "
