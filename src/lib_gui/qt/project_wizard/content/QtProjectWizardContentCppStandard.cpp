...
QtProjectWizardContentCppStandard::QtProjectWizardContentCppStandard(
    std::shared_ptr<SourceGroupSettingsWithCppStandard> sourceGroupSettings, QtProjectWizardWindow* window)
...
void QtProjectWizardContentCppStandard::populate(QGridLayout* layout, int& row) {
  ...
  layout->addWidget(createFormLabel(QStringLiteral("C++ Standard")), row, QtProjectWizardWindow::FRONT_COL,
                    Qt::AlignRight);
