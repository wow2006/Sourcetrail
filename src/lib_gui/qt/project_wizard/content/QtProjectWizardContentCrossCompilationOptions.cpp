...
void QtProjectWizardContentCrossCompilationOptions::populate(QGridLayout* layout, int& row) {
  ...
  addHelpButton("Cross-Compilation",
                QStringLiteral("<p>Use these options to specify the target architecture for the provided source code. "
...

  {
    ...
    connect(m_useTargetOptions, &QCheckBox::stateChanged, this,
...
bool QtProjectWizardContentCrossCompilationOptions::check() { return true; }

void QtProjectWizardContentCrossCompilationOptions::onUseTargetOptionsChanged() { updateTargetOptionsEnabled(); }
