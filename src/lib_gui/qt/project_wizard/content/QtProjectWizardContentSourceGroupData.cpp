...
void QtProjectWizardContentSourceGroupData::populate(QGridLayout* layout, int& row) {
  ...
  layout->addWidget(createFormLabel(QStringLiteral("Source Group Name")), row, QtProjectWizardWindow::FRONT_COL,
                    Qt::AlignRight);
  ...
  layout->addWidget(createFormSubLabel(QStringLiteral("Status")), row, QtProjectWizardWindow::FRONT_COL,
                    Qt::AlignRight);
  layout->addWidget(m_status, row, QtProjectWizardWindow::BACK_COL);

  addHelpButton(QStringLiteral("Status"),
