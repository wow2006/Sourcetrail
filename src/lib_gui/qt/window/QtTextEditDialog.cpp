...
QSize QtTextEditDialog::sizeHint() const { return QSize(550, 550); }

void QtTextEditDialog::setText(const std::wstring& text) { m_text->setPlainText(QString::fromStdWString(text)); }

std::wstring QtTextEditDialog::getText() { return m_text->toPlainText().toStdWString(); }
