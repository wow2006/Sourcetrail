...
QtIndexingStartDialog::QtIndexingStartDialog(const std::vector<RefreshMode>& enabledModes,
                                             ...
                                             bool initialShallowState, QWidget* parent)
  ...
  m_refreshModeButtons.emplace(RefreshMode::REFRESH_UPDATED_FILES, new QRadioButton(QStringLiteral("Updated files")));
  m_refreshModeButtons.emplace(RefreshMode::REFRESH_UPDATED_AND_INCOMPLETE_FILES,
...
QSize QtIndexingStartDialog::sizeHint() const { return QSize(350, 310); }
...
void QtIndexingStartDialog::resizeEvent(QResizeEvent* event) { QtIndexingDialog::resizeEvent(event); }

void QtIndexingStartDialog::closeEvent(QCloseEvent* event) { emit QtIndexingDialog::canceled(); }
...
void QtIndexingStartDialog::onCancelPressed() { emit canceled(); }
