...
void QtAbout::setupAbout() {
...

  {
    ...
    auto* sourcetrailLogoLabel = new QLabel(this);
...

  {
    auto* versionLabel = new QLabel(
        ("Version " + Version::getApplicationVersion().toDisplayString() + " - " +
         std::string(utility::getApplicationArchitectureType() == APPLICATION_ARCHITECTURE_X86_32 ?
                         "32" :
                         "64") +
         " bit")
            .c_str(),
  ...
  {
    auto* dbVersionLabel = new QLabel(
  ...
  {
    auto* layoutHorz1 = new QHBoxLayout();
  ...
  {
    auto* acknowledgementsLabel = new QLabel(QString::fromStdString(
