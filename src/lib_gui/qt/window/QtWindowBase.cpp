...
QSize QtWindowBase::sizeHint() const {
  return QSize(ApplicationSettings::getInstance()->getWindowBaseWidth(),
...
bool QtWindowBase::isSubWindow() const { return m_isSubWindow; }
...
void QtWindowBase::showWindow() { show(); }

void QtWindowBase::hideWindow() { hide(); }
