...
QtBookmarkBrowser::QtBookmarkBrowser(ControllerProxy<BookmarkController>* controllerProxy,
                                     QWidget* parent)
...
void QtBookmarkBrowser::setupBookmarkBrowser() {
  setStyleSheet((utility::getStyleSheet(
                 ...
                 utility::getStyleSheet(
                     ResourcePaths::getGuiDirectoryPath().concatenate(L"bookmark_view/"
                                                                      L"bookmark_view.css")))
                    .c_str());
