...
QSize QtUnknownProgressDialog::sizeHint() const { return QSize(350, 280); }

void QtUnknownProgressDialog::closeEvent(QCloseEvent* event) { emit visibleChanged(false); }

void QtUnknownProgressDialog::onHidePressed() { emit visibleChanged(false); }
