...
class QtIndexingStartDialog : public QtIndexingDialog {
 ...
 public:
  QtIndexingStartDialog(const std::vector<RefreshMode>& enabledModes, const RefreshMode initialMode,
                        bool enabledShallowOption, bool initialShallowState, QWidget* parent = 0);
