...
QtKeyboardShortcuts::Shortcut::Shortcut(const QString& name_, const QString& shortcut_)
...
void QtKeyboardShortcuts::addShortcuts(QtShortcutTable* table,
                                       const std::vector<Shortcut>& shortcuts) const {
...
QTableWidget* QtKeyboardShortcuts::createGeneralShortcutsTable() {
  ...
  addShortcuts(
      ...
      {Shortcut(QStringLiteral("Switch Focus between Graph and Code"), QStringLiteral("Tab")),
       ...
       Shortcut::defaultOrMac(QStringLiteral("Back"),
                              QStringLiteral("Alt + Left | Z | Y | Backspace"),
                              QStringLiteral("Cmd + [ | Z | Y | Backspace")),
       Shortcut::defaultOrMac(QStringLiteral("Forward"),
       ...
       Shortcut::winMacOrLinux(QStringLiteral("Close Window"),
       ...
       Shortcut::defaultOrMac(QStringLiteral("To Overview"),
                              QStringLiteral("Ctrl + Home"),
                              QStringLiteral("Cmd + Home | Cmd + Up")),
       Shortcut::defaultOrMac(
           QStringLiteral("Preferences"), QStringLiteral("Ctrl + ,"), QStringLiteral("Cmd + ,")),
       Shortcut::defaultOrMac(QStringLiteral("Bookmark Active Symbol"),
                              QStringLiteral("Ctrl + S"),
                              QStringLiteral("Cmd + S")),
       Shortcut::defaultOrMac(QStringLiteral("Bookmark Manager"),
...
QTableWidget* QtKeyboardShortcuts::createCodeViewShortcutsTable() {
  ...
  addShortcuts(
      ...
      {Shortcut(QStringLiteral("Move Focus Within Code"), QStringLiteral("WASD | HJKL | Arrows")),
       ...
       Shortcut::defaultOrMac(QStringLiteral("Previous Reference"),
                              QStringLiteral("Ctrl + Shift + G"),
                              QStringLiteral("Cmd + Shift + G")),
       Shortcut::defaultOrMac(QStringLiteral("Next Local Reference"),
       ...
       Shortcut::defaultOrMac(QStringLiteral("Scroll Code Area"),
  ...
  addShortcuts(
      ...
      {Shortcut(QStringLiteral("Move Focus Within Nodes"), QStringLiteral("WASD | HJKL | Arrows")),
       ...
       Shortcut::defaultOrMac(QStringLiteral("Activate Node in New Tab"),
                              QStringLiteral("Ctrl + Shift + Enter | Ctrl + Shift + E"),
                              QStringLiteral("Cmd + Shift + Enter | Cmd + Shift + E")),
       Shortcut::defaultOrMac(QStringLiteral("Scroll Graph Area"),
                              QStringLiteral("Ctrl + Arrows"),
                              QStringLiteral("Cmd + Arrows")),
       ...
       Shortcut::defaultOrMac(QStringLiteral("Open Custom Trail Dialog"),
