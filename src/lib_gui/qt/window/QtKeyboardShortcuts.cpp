...
void QtShortcutTable::wheelEvent(QWheelEvent* event) { event->ignore(); }

QtKeyboardShortcuts::QtKeyboardShortcuts(QWidget* parent) : QtWindow(false, parent) { setScrollAble(true); }

QtKeyboardShortcuts::~QtKeyboardShortcuts() {}

QSize QtKeyboardShortcuts::sizeHint() const { return QSize(666, 666); }
...
QtKeyboardShortcuts::Shortcut QtKeyboardShortcuts::Shortcut::winMacOrLinux(const QString& name,
...
QTableWidget* QtKeyboardShortcuts::createGeneralShortcutsTable() {
  ...
  addShortcuts(
      ...
      {Shortcut(QStringLiteral("Switch Focus between Graph and Code"), QStringLiteral("Tab")),
       ...
       Shortcut::defaultOrMac(QStringLiteral("Back"), QStringLiteral("Alt + Left | Z | Y | Backspace"),
                              QStringLiteral("Cmd + [ | Z | Y | Backspace")),
       Shortcut::defaultOrMac(QStringLiteral("Forward"), QStringLiteral("Alt + Right | Shift + Z | Shift + Y"),
                              QStringLiteral("Cmd + ] | Shift + Z | Shift + Y")),
       Shortcut::defaultOrMac(QStringLiteral("Refresh"), QStringLiteral("F5"), QStringLiteral("Cmd + R")),
       Shortcut::defaultOrMac(QStringLiteral("Full Refresh"), QStringLiteral("Shift + F5"),
                              QStringLiteral("Cmd + Shift + R")),
       Shortcut::defaultOrMac(QStringLiteral("Find Symbol"), QStringLiteral("Ctrl + F"), QStringLiteral("Cmd + F")),
       Shortcut::defaultOrMac(QStringLiteral("Find Text"), QStringLiteral("Ctrl + Shift + F"),
                              QStringLiteral("Cmd + Shift + F")),
       Shortcut::defaultOrMac(QStringLiteral("Find On-Screen"), QStringLiteral("Ctrl + D | /"),
       ...
       Shortcut::winMacOrLinux(QStringLiteral("Close Window"), QStringLiteral("Alt + F4"), QStringLiteral("Cmd + W"),
                               QStringLiteral("Ctrl + W")),
       Shortcut::defaultOrMac(QStringLiteral("Hide Window"), QStringLiteral(""), QStringLiteral("Cmd + H")),
       Shortcut::defaultOrMac(QStringLiteral("To Overview"), QStringLiteral("Ctrl + Home"),
                              QStringLiteral("Cmd + Home | Cmd + Up")),
       Shortcut::defaultOrMac(QStringLiteral("Preferences"), QStringLiteral("Ctrl + ,"), QStringLiteral("Cmd + ,")),
       Shortcut::defaultOrMac(QStringLiteral("Bookmark Active Symbol"), QStringLiteral("Ctrl + S"),
                              QStringLiteral("Cmd + S")),
       Shortcut::defaultOrMac(QStringLiteral("Bookmark Manager"), QStringLiteral("Ctrl + B"),
...
QTableWidget* QtKeyboardShortcuts::createCodeViewShortcutsTable() {
  ...
  addShortcuts(table, {Shortcut(QStringLiteral("Move Focus Within Code"), QStringLiteral("WASD | HJKL | Arrows")),
                       Shortcut(QStringLiteral("Move Focus to Closest Reference"),
                                QStringLiteral("Shift + WASD | Shift + HJKL | Shift + Arrows")),
                       Shortcut(QStringLiteral("Activate Location"), QStringLiteral("Enter | E")),
                       Shortcut::defaultOrMac(QStringLiteral("Activate Location in New Tab"),
                                              QStringLiteral("Ctrl + Shift + Enter | Ctrl + Shift + E"),
                                              QStringLiteral("Cmd + Shift + Enter | Cmd + Shift + E")),
                       Shortcut::defaultOrMac(QStringLiteral("Next Reference"), QStringLiteral("Ctrl + G"),
                                              QStringLiteral("Cmd + G")),
                       Shortcut::defaultOrMac(QStringLiteral("Previous Reference"), QStringLiteral("Ctrl + Shift + G"),
                                              QStringLiteral("Cmd + Shift + G")),
                       Shortcut::defaultOrMac(QStringLiteral("Next Local Reference"), QStringLiteral("Ctrl + L"),
                                              QStringLiteral("Cmd + L")),
                       Shortcut::defaultOrMac(QStringLiteral("Previous Local Reference"),
                                              QStringLiteral("Ctrl + Shift + L"), QStringLiteral("Cmd + Shift + L")),
                       Shortcut::defaultOrMac(QStringLiteral("Scroll Code Area"), QStringLiteral("Ctrl + Arrows"),
...
QTableWidget* QtKeyboardShortcuts::createGraphViewShortcutsTable() {
  ...
  addShortcuts(table, {Shortcut(QStringLiteral("Move Focus Within Nodes"), QStringLiteral("WASD | HJKL | Arrows")),
                       Shortcut(QStringLiteral("Move Focus Within Edges"),
                                QStringLiteral("Shift + WASD | Shift + HJKL | Shift + Arrows")),
                       ...
                       Shortcut::defaultOrMac(QStringLiteral("Activate Node in New Tab"),
                                              QStringLiteral("Ctrl + Shift + Enter | Ctrl + Shift + E"),
                                              QStringLiteral("Cmd + Shift + Enter | Cmd + Shift + E")),
                       Shortcut::defaultOrMac(QStringLiteral("Scroll Graph Area"), QStringLiteral("Ctrl + Arrows"),
                                              QStringLiteral("Cmd + Arrows")),
                       Shortcut::defaultOrMac(QStringLiteral("Zoom in"),
                                              QStringLiteral("Ctrl + Shift + Up | Ctrl + Mouse Wheel Up"),
                                              QStringLiteral("Cmd + Shift + Up | Cmd + Mouse Wheel Up")),
                       Shortcut::defaultOrMac(QStringLiteral("Zoom out"),
                       ...
                       Shortcut::defaultOrMac(QStringLiteral("Open Custom Trail Dialog"), QStringLiteral("Ctrl + U"),
