...
QtRoundedRectItem::QtRoundedRectItem(QGraphicsItem* parent) : QGraphicsRectItem(parent), m_radius(0.0f) {
  this->setZValue(-1.0f);
}
...
qreal QtRoundedRectItem::getRadius() const { return m_radius; }

void QtRoundedRectItem::setRadius(qreal radius) { m_radius = radius; }
