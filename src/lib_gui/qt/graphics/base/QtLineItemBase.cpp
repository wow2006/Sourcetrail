...
void QtLineItemBase::updateLine(const Vec4i& ownerRect, const Vec4i& targetRect, const Vec4i& ownerParentRect,
                                const Vec4i& targetParentRect, const GraphViewStyle::EdgeStyle& style, size_t weight,
                                bool showArrow) {
