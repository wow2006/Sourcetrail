...
QtGraphNodeGroup::QtGraphNodeGroup(GraphFocusHandler* focusHandler, Id tokenId, const std::wstring& name,
                                   GroupType type, bool interactive)
...
bool QtGraphNodeGroup::isGroupNode() const { return true; }

Id QtGraphNodeGroup::getTokenId() const { return m_tokenId; }
