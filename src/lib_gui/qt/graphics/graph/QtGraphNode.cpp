...
const Vec2i& QtGraphNode::getSize() const { return m_size; }
...
const Vec2i& QtGraphNode::getColumnSize() const { return m_columnSize; }

void QtGraphNode::setColumnSize(const Vec2i& size) { m_columnSize = size; }

QSize QtGraphNode::size() const { return QSize(m_size.x, m_size.y); }

void QtGraphNode::setSize(QSize size) { setSize(Vec2i(size.width(), size.height())); }
