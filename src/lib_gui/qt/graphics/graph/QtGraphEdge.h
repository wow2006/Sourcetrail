...
class QtGraphEdge : public QObject, public QGraphicsItemGroup {
 ...
 public:
  ...
  QtGraphEdge(GraphFocusHandler* focusHandler, QtGraphNode* owner, QtGraphNode* target, const Edge* data, size_t weight,
              bool isActive, bool isInteractive, bool horizontal, TokenComponentBundledEdges::Direction direction);
  virtual ~QtGraphEdge();
