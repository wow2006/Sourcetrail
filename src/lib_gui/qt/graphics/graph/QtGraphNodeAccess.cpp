...
AccessKind QtGraphNodeAccess::getAccessKind() const { return m_accessKind; }

bool QtGraphNodeAccess::isAccessNode() const { return true; }
...
void QtGraphNodeAccess::hideLabel() { m_text->hide(); }
