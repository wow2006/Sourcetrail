...
std::shared_ptr<TestStorage> parseCode(std::string code, std::vector<std::wstring> compilerFlags = {}) {
  ...
  CxxParser parser(std::make_shared<ParserClientImpl>(storage.get()), std::make_shared<TestFileRegister>(),
                   std::make_shared<IndexerStateInfo>());
  parser.buildIndex(L"input.cc", TextAccess::createFromString(code),
...
TEST_CASE("cxx parser finds static global variable declaration") {
  ...
  REQUIRE(utility::containsElement<std::wstring>(client->globalVariables, L"int x (input.cc) <1:12 1:12>"));
}
...
TEST_CASE("cxx parser finds static const global variable declaration") {
  ...
  REQUIRE(utility::containsElement<std::wstring>(client->globalVariables, L"const int x (input.cc) <1:18 1:18>"));
}
...
TEST_CASE("cxx parser finds fields in class with access type") {
  ...
  REQUIRE(utility::containsElement<std::wstring>(client->fields, L"protected static int A::c <8:13 8:13>"));
  REQUIRE(utility::containsElement<std::wstring>(client->fields, L"private const int A::d <10:12 10:12>"));
}
...
TEST_CASE("cxx parser finds function declaration") {
  ...
  REQUIRE(utility::containsElement<std::wstring>(client->functions, L"int ceil(float) <1:1 <1:1 <1:5 1:8> 1:17> 4:1>"));
}
...
TEST_CASE("cxx parser finds method declaration") {
  ...
  REQUIRE(utility::containsElement<std::wstring>(client->methods, L"public void B::B() <4:2 <4:2 4:2> 4:4>"));
}
...
TEST_CASE("cxx parser finds overloaded operator declaration") {
  ...
  REQUIRE(utility::containsElement<std::wstring>(client->methods,
                                                 L"public B & B::operator=(const B &) <4:2 <4:5 4:13> 4:29>"));
}
...
TEST_CASE("cxx parser finds method declaration and definition") {
  ...
  REQUIRE(utility::containsElement<std::wstring>(client->methods, L"public void B::B() <6:1 <6:4 6:4> 8:1>"));
}
...
TEST_CASE("cxx parser finds virtual method declaration") {
  ...
  REQUIRE(utility::containsElement<std::wstring>(client->methods, L"public void B::process() <4:2 <4:15 4:21> 4:23>"));
}
...
TEST_CASE("cxx parser finds pure virtual method declaration") {
  ...
  REQUIRE(
      utility::containsElement<std::wstring>(client->methods, L"protected void B::process() <4:2 <4:15 4:21> 4:27>"));
}
...
TEST_CASE("cxx parser finds anonymous namespace declaration") {
  ...
  REQUIRE(utility::containsElement<std::wstring>(client->namespaces,
                                                 L"anonymous namespace (input.cc<1:1>) <1:1 <2:1 2:1> 3:1>"));
}
...
TEST_CASE("cxx parser finds multiple anonymous namespace declarations as same symbol") {
  ...
  REQUIRE(utility::containsElement<std::wstring>(client->namespaces,
                                                 L"anonymous namespace (input.cc<1:1>) <4:1 <5:1 5:1> 6:1>"));
}
...
TEST_CASE("cxx parser finds multiple nested anonymous namespace declarations as different symbol") {
  ...
  REQUIRE(utility::containsElement<std::wstring>(client->namespaces,
                                                 L"anonymous namespace (input.cc<1:1>) <1:1 <2:1 2:1> 6:1>"));
...
TEST_CASE(
  ...
  REQUIRE(utility::containsElement<std::wstring>(client->namespaces,
                                                 L"a::anonymous namespace (input.cc<3:2>) <3:2 <4:2 4:2> 5:2>"));

  REQUIRE(utility::containsElement<std::wstring>(client->namespaces, L"b <7:1 <7:11 7:11> 12:1>"));

  REQUIRE(utility::containsElement<std::wstring>(client->namespaces,
                                                 L"b::anonymous namespace (input.cc<9:2>) <9:2 <10:2 10:2> 11:2>"));
}
...
TEST_CASE(
  ...
  REQUIRE(utility::containsElement<std::wstring>(client->namespaces,
                                                 L"a::anonymous namespace (input.cc<3:2>) <9:2 <10:2 10:2> 11:2>"));
}
...
TEST_CASE("cxx parser finds anonymous struct declaration") {
  ...
  REQUIRE(utility::containsElement<std::wstring>(client->structs,
                                                 L"anonymous struct (input.cc<1:9>) <1:9 <1:9 1:14> 4:1>"));
}
...
TEST_CASE("cxx parser finds multiple anonymous struct declarations as distinct elements") {
  ...
  REQUIRE(utility::substrBeforeLast(client->fields[0], '<') != utility::substrBeforeLast(client->fields[1], '<'));
}
...
TEST_CASE("cxx parser finds anonymous union declaration") {
  ...
  REQUIRE(
      utility::containsElement<std::wstring>(client->unions, L"anonymous union (input.cc<1:9>) <1:9 <1:9 1:13> 5:1>"));
}
...
TEST_CASE("cxx parser finds typedef in anonymous namespace") {
  ...
  REQUIRE(utility::containsElement<std::wstring>(client->typedefs,
                                                 L"anonymous namespace (input.cc<1:1>)::uint <3:23 3:26>"));
}
...
TEST_CASE("cxx parser finds type alias in class") {
  ...
  REQUIRE(utility::containsElement<std::wstring>(client->typedefs, L"private Foo::Bar <3:8 3:10>"));
}
...
TEST_CASE("cxx parser finds macro in ifdefined") {
  ...
  REQUIRE(utility::containsElement<std::wstring>(client->macroUses, L"input.cc -> PI <2:13 2:14>"));
}
...
TEST_CASE("cxx parser finds macro expand") {
  ...
  REQUIRE(utility::containsElement<std::wstring>(client->macroUses, L"input.cc -> PI <4:12 4:13>"));
}
...
TEST_CASE("cxx parser finds macro expand within macro") {
  ...
  REQUIRE(utility::containsElement<std::wstring>(client->macroUses, L"input.cc -> PI <2:18 2:19>"));
}
...
TEST_CASE("cxx parser finds type template parameter definition of template type alias") {
  ...
  REQUIRE(utility::containsElement<std::wstring>(client->localSymbols, L"input.cc<1:16> <1:16 1:16>"));
}
...
TEST_CASE("cxx parser finds type template parameter definition of class template") {
  ...
  REQUIRE(utility::containsElement<std::wstring>(client->localSymbols, L"input.cc<1:20> <1:20 1:20>"));
}
...
TEST_CASE(
  ...
  REQUIRE(utility::containsElement<std::wstring>(client->localSymbols, L"input.cc<5:20> <5:20 5:20>"));

  REQUIRE(utility::containsElement<std::wstring>(client->localSymbols, L"input.cc<5:20> <6:9 6:9>"));
}
...
TEST_CASE(
  ...
  REQUIRE(utility::containsElement<std::wstring>(client->localSymbols, L"input.cc<4:20> <4:20 4:20>"));

  REQUIRE(utility::containsElement<std::wstring>(client->localSymbols, L"input.cc<4:20> <5:12 5:12>"));
}
...
TEST_CASE("cxx parser finds type template parameter defined with class keyword") {
  ...
  REQUIRE(utility::containsElement<std::wstring>(client->localSymbols, L"input.cc<1:17> <1:17 1:17>"));
}
...
TEST_CASE("cxx parser finds non type int template parameter definition of template class") {
  ...
  REQUIRE(utility::containsElement<std::wstring>(client->localSymbols, L"input.cc<1:15> <1:15 1:15>"));
}
...
TEST_CASE("cxx parser finds non type custom pointer template parameter definition of template class") {
  std::shared_ptr<TestStorage> client = parseCode(
      "class P\n"
      "{};\n"
      "template <P* p>\n"
  ...
  REQUIRE(utility::containsElement<std::wstring>(client->localSymbols, L"input.cc<3:14> <3:14 3:14>"));
}

TEST_CASE("cxx parser finds non type custom reference template parameter definition of template class") {
  std::shared_ptr<TestStorage> client = parseCode(
      "class P\n"
      "{};\n"
      "template <P& p>\n"
...
TEST_CASE(
  ...
  REQUIRE(utility::containsElement<std::wstring>(client->localSymbols, L"input.cc<1:28> <1:28 1:29>"));

  // and usage
  REQUIRE(utility::containsElement<std::wstring>(client->localSymbols, L"input.cc<1:20> <1:24 1:25>"));
}
...
TEST_CASE(
  ...
  REQUIRE(utility::containsElement<std::wstring>(client->localSymbols, L"input.cc<1:49> <1:49 1:50>"));

  REQUIRE(utility::containsElement<std::wstring>(client->localSymbols, L"input.cc<1:36> <1:40 1:41>"));
}
...
TEST_CASE(
  ...
  REQUIRE(utility::containsElement<std::wstring>(client->localSymbols, L"input.cc<1:45> <1:45 1:45>"));

  REQUIRE(utility::containsElement<std::wstring>(client->localSymbols, L"input.cc<1:29> <1:32 1:32>"));
}
...
TEST_CASE("cxx parser finds template template parameter of template class") {
  ...
  REQUIRE(utility::containsElement<std::wstring>(client->localSymbols, L"input.cc<4:36> <4:36 4:36>"));
}
...
TEST_CASE("cxx parser finds type template parameter pack type of template class") {
  ...
  REQUIRE(utility::containsElement<std::wstring>(client->localSymbols, L"input.cc<1:23> <1:23 1:23>"));
}
...
TEST_CASE("cxx parser finds non type int template parameter pack type of template class") {
  ...
  REQUIRE(utility::containsElement<std::wstring>(client->localSymbols, L"input.cc<1:18> <1:18 1:18>"));
}
...
TEST_CASE("cxx parser finds template template parameter pack type of template class") {
  ...
  REQUIRE(utility::containsElement<std::wstring>(client->localSymbols, L"input.cc<1:42> <1:42 1:42>"));
}
...
TEST_CASE("cxx parser finds type template parameters of template class with multiple parameters") {
  ...
  REQUIRE(utility::containsElement<std::wstring>(client->localSymbols, L"input.cc<1:20> <1:20 1:20>"));
  REQUIRE(utility::containsElement<std::wstring>(client->localSymbols, L"input.cc<1:32> <1:32 1:32>"));
}
...
TEST_CASE("cxx parser skips creating node for template parameter without a name") {
  ...
  REQUIRE(utility::containsElement<std::wstring>(client->classes, L"A<typename> <1:1 <2:7 2:7> 4:1>"));
}

TEST_CASE("cxx parser finds type template parameter of template method definition outside template class") {
  std::shared_ptr<TestStorage> client = parseCode(
      "template <typename T>\n"
      "class A\n"
      "{\n"
  ...
  REQUIRE(utility::containsElement<std::wstring>(client->localSymbols, L"input.cc<8:20> <8:20 8:20>"));
}
...
TEST_CASE("cxx parser finds explicit variable template specialization") {
  ...
  REQUIRE(utility::containsElement<std::wstring>(client->globalVariables, L"int t<int> <5:5 5:5>"));
}
...
TEST_CASE("cxx parser finds explicit partial class template specialization") {
  ...
  REQUIRE(utility::containsElement<std::wstring>(client->classes, L"A<typename T, int> <5:1 <6:7 6:7> 8:1>"));
}
...
TEST_CASE("cxx parser finds explicit partial variable template specialization") {
  ...
  REQUIRE(utility::containsElement<std::wstring>(client->globalVariables, L"int t<int, typename R> <5:5 5:5>"));
}
...
TEST_CASE("cxx parser finds correct field member name of template class in declaration") {
  ...
  REQUIRE(utility::containsElement<std::wstring>(client->fields, L"private int A<typename T>::foo <4:6 4:8>"));
}
...
TEST_CASE("cxx parser finds correct type of field member of template class in declaration") {
  ...
  REQUIRE(utility::containsElement<std::wstring>(client->typeUses, L"int A<int>::foo -> int <4:2 4:2>"));

  REQUIRE(utility::containsElement<std::wstring>(client->typeUses, L"A<int> a -> A<int> <6:1 6:1>"));

  REQUIRE(utility::containsElement<std::wstring>(client->typeUses, L"A<int> a -> int <6:3 6:5>"));

  REQUIRE(utility::containsElement<std::wstring>(client->localSymbols, L"input.cc<1:20> <4:2 4:2>"));
}
...
TEST_CASE("cxx parser finds correct method member name of template class in declaration") {
  ...
  REQUIRE(utility::containsElement<std::wstring>(client->methods,
                                                 L"private int A<typename T>::foo() <4:2 <4:6 4:8> 4:10>"));
}
...
TEST_CASE("cxx parser finds non type custom pointer template parameter definition of template function") {
  std::shared_ptr<TestStorage> client = parseCode(
      "class P\n"
      "{};\n"
      "template <P* p>\n"
...
TEST_CASE("cxx parser finds non type custom reference template parameter definition of template function") {
  std::shared_ptr<TestStorage> client = parseCode(
      "class P\n"
      "{};\n"
      "template <P& p>\n"
...
TEST_CASE("cxx parser finds function for implicit instantiation of template function") {
  ...
  REQUIRE(
      utility::containsElement<std::wstring>(client->functions, L"int test<int>(int) <2:1 <2:1 <2:3 2:6> 2:11> 5:1>"));
}

TEST_CASE("cxx parser skips implicit template method definition of implicit template class instantiation") {
  std::shared_ptr<TestStorage> client = parseCode(
      "template <typename T>\n"
      "class A\n"
      "{\n"
...
TEST_CASE("cxx parser finds local variable declared in lambda capture") {
  ...
  REQUIRE(utility::containsElement<std::wstring>(client->localSymbols, L"input.cc<3:3> <3:3 3:3>"));
  REQUIRE(utility::containsElement<std::wstring>(client->localSymbols, L"input.cc<3:3> <3:21 3:21>"));
}
...
TEST_CASE("cxx parser finds definition of local symbol in function scope") {
  ...
  REQUIRE(utility::containsElement<std::wstring>(client->localSymbols, L"input.cc<3:6> <3:6 3:6>"));
}
...
TEST_CASE("cxx parser finds struct definition in class") {
  ...
  REQUIRE(utility::containsElement<std::wstring>(client->structs, L"private A::B <3:2 <3:9 3:9> 5:2>"));
}
...
TEST_CASE("cxx parser finds field in nested class") {
  ...
  REQUIRE(utility::containsElement<std::wstring>(client->fields, L"private static const int B::C::amount <7:20 7:25>"));
}
...
TEST_CASE("cxx parser finds method declared in nested class") {
  ...
  REQUIRE(utility::containsElement<std::wstring>(client->methods,
                                                 L"private bool B::C::isGreat() const <5:3 <5:8 5:14> 5:22>"));
}
...
TEST_CASE("cxx parser finds nested named namespace") {
  ...
  REQUIRE(utility::containsElement<std::wstring>(client->namespaces, L"A::B <3:2 <3:12 3:12> 5:2>"));
}
...
TEST_CASE("cxx parser finds enum defined in class") {
  ...
  REQUIRE(utility::containsElement<std::wstring>(client->enums, L"public B::Z <4:2 <4:7 4:7> 6:2>"));
}
...
TEST_CASE("cxx parser finds enum definition in template class") {
  ...
  REQUIRE(
      utility::containsElement<std::wstring>(client->enums, L"private A<typename T>::TestType <4:2 <4:7 4:14> 8:2>"));
}
...
TEST_CASE("cxx parser finds enum constants in template class") {
  ...
  REQUIRE(
      utility::containsElement<std::wstring>(client->enumConstants, L"A<typename T>::TestType::TEST_ONE <6:3 6:10>"));
}
...
TEST_CASE("cxx parser finds implicit copy constructor") {
  ...
  REQUIRE(utility::containsElement<std::wstring>(client->methods,
                                                 L"public void TestClass::TestClass() <1:7 <1:7 1:15> 1:15>"));
  REQUIRE(utility::containsElement<std::wstring>(
...
TEST_CASE("cxx parser finds correct field member type of nested template class in declaration") {
  ...
  REQUIRE(utility::containsElement<std::wstring>(client->localSymbols, L"input.cc<1:20> <7:3 7:3>"));
  REQUIRE(utility::containsElement<std::wstring>(client->typeUses, L"int A<int>::B::foo -> int <7:3 7:3>"));
  REQUIRE(utility::containsElement<std::wstring>(client->typeUses, L"A<int> a -> A<int> <10:1 10:1>"));
  REQUIRE(utility::containsElement<std::wstring>(client->typeUses, L"A<int> -> int <10:3 10:5>"));
  REQUIRE(utility::containsElement<std::wstring>(client->typeUses, L"A<int> a -> int <10:3 10:5>"));
  REQUIRE(utility::containsElement<std::wstring>(client->typeUses, L"A<int>::B b -> A<int>::B <11:9 11:9>"));
}
...
TEST_CASE("cxx parser finds typedefs type use") {
  ...
  REQUIRE(utility::containsElement<std::wstring>(client->typeUses, L"uint -> unsigned int <1:9 1:16>"));
}
...
TEST_CASE("cxx parser finds typedef that uses type defined in named namespace") {
  ...
  REQUIRE(
      utility::containsElement<std::wstring>(client->typeUses, L"globalTestStruct -> test::TestStruct <5:15 5:24>"));
}
...
TEST_CASE("cxx parser finds type use of typedef") {
  ...
  REQUIRE(utility::containsElement<std::wstring>(client->typeUses, L"uint number -> uint <2:1 2:4>"));
}
...
TEST_CASE("cxx parser finds method override when virtual") {
  ...
  REQUIRE(utility::containsElement<std::wstring>(client->overrides, L"void B::foo() -> void A::foo() <5:7 5:9>"));
}
...
TEST_CASE("cxx parser finds multi layer method overrides") {
  ...
  REQUIRE(utility::containsElement<std::wstring>(client->overrides, L"void B::foo() -> void A::foo() <5:7 5:9>"));
  REQUIRE(utility::containsElement<std::wstring>(client->overrides, L"void C::foo() -> void B::foo() <8:7 8:9>"));
}
...
TEST_CASE("cxx parser finds method overrides on different return types") {
  ...
  REQUIRE(utility::containsElement<std::wstring>(client->overrides, L"int B::foo() -> void A::foo() <5:6 5:8>"));
}
...
TEST_CASE("cxx parser finds using directive decl in function context") {
  ...
  REQUIRE(utility::containsElement<std::wstring>(client->usages, L"void foo() -> std <3:18 3:20>"));
}
...
TEST_CASE("cxx parser finds using decl in function context") {
  ...
  REQUIRE(utility::containsElement<std::wstring>(client->usages, L"void bar() -> foo::a <7:13 7:13>"));
}
...
TEST_CASE("cxx parser finds using decl in file context") {
  ...
  REQUIRE(utility::containsElement<std::wstring>(client->usages, L"input.cc -> foo::a <5:12 5:12>"));
}
...
TEST_CASE("cxx parser finds call in function") {
  ...
  REQUIRE(utility::containsElement<std::wstring>(client->calls, L"int main() -> int sum(int, int) <7:2 7:4>"));
}
...
TEST_CASE("cxx parser finds call in function with correct signature") {
  ...
  REQUIRE(utility::containsElement<std::wstring>(client->calls, L"void func(bool) -> int sum(int, int) <10:2 10:4>"));
}
...
TEST_CASE("cxx parser finds call to function with right signature") {
  ...
  REQUIRE(utility::containsElement<std::wstring>(client->calls, L"int main() -> int sum(int, int) <11:2 11:4>"));
  REQUIRE(utility::containsElement<std::wstring>(client->calls, L"int main() -> float sum(float, float) <12:2 12:4>"));
}
...
TEST_CASE("cxx parser finds function call in function parameter list") {
  ...
  REQUIRE(utility::containsElement<std::wstring>(client->calls, L"int main() -> int sum(int, int) <7:16 7:18>"));
}
...
TEST_CASE("cxx parser finds function call in method") {
  ...
  REQUIRE(utility::containsElement<std::wstring>(client->calls, L"int App::main() -> int sum(int, int) <9:10 9:12>"));
}
...
TEST_CASE("cxx parser finds implicit constructor without definition call") {
  ...
  REQUIRE(utility::containsElement<std::wstring>(client->calls, L"int main() -> void App::App() <6:6 6:8>"));
}
...
TEST_CASE("cxx parser finds explicit constructor call") {
  ...
  REQUIRE(utility::containsElement<std::wstring>(client->calls, L"int main() -> void App::App() <8:2 8:4>"));
}
...
TEST_CASE("cxx parser finds call of explicitly defined destructor at delete keyword") {
  ...
  REQUIRE(utility::containsElement<std::wstring>(client->calls, L"void foo() -> void Foo::~Foo() <11:2 11:7>"));
}
...
TEST_CASE("cxx parser finds call of implicitly defined destructor at delete keyword") {
  ...
  REQUIRE(utility::containsElement<std::wstring>(client->calls, L"void foo() -> void Foo::~Foo() <8:2 8:7>"));
}
...
TEST_CASE("cxx parser finds explicit constructor call of field") {
  ...
  REQUIRE(utility::containsElement<std::wstring>(client->calls, L"void App::App() -> void Item::Item() <7:10 7:13>"));
}
...
TEST_CASE("cxx parser finds function call in member initialization") {
  ...
  REQUIRE(utility::containsElement<std::wstring>(client->calls, L"void App::App() -> int one() <10:10 10:12>"));
}
...
TEST_CASE("cxx parser finds copy constructor call") {
  ...
  REQUIRE(
      utility::containsElement<std::wstring>(client->calls, L"int main() -> void App::App(const App &) <10:6 10:9>"));
}
...
TEST_CASE("cxx parser finds global variable constructor call") {
  ...
  REQUIRE(utility::containsElement<std::wstring>(client->calls, L"App app -> void App::App() <6:5 6:7>"));
}
...
TEST_CASE("cxx parser finds operator call") {
  ...
  REQUIRE(utility::containsElement<std::wstring>(client->calls, L"int main() -> void App::operator+(int) <11:6 11:6>"));
}
...
TEST_CASE("cxx parser finds usage of function pointer") {
  ...
  REQUIRE(utility::containsElement<std::wstring>(client->usages, L"void test() -> void my_int_func(int) <8:9 8:19>"));
}
...
TEST_CASE("cxx parser finds usage of global variable in function") {
  ...
  REQUIRE(utility::containsElement<std::wstring>(client->usages, L"int main() -> int bar <5:2 5:4>"));
}
...
TEST_CASE("cxx parser finds usage of global variable in global variable initialization") {
  ...
  REQUIRE(utility::containsElement<std::wstring>(client->usages, L"int [] b -> int a <2:12 2:12>"));
}
...
TEST_CASE("cxx parser finds usage of global variable in method") {
  ...
  REQUIRE(utility::containsElement<std::wstring>(client->usages, L"void App::foo() -> int bar <7:3 7:5>"));
}
...
TEST_CASE("cxx parser finds usage of field in method") {
  ...
  REQUIRE(utility::containsElement<std::wstring>(client->usages, L"void App::foo() -> int App::bar <5:3 5:5>"));
  REQUIRE(utility::containsElement<std::wstring>(client->usages, L"void App::foo() -> int App::bar <6:9 6:11>"));
}
...
TEST_CASE("cxx parser finds usage of field in function call arguments") {
  ...
  REQUIRE(utility::containsElement<std::wstring>(client->usages, L"void A::foo(int) -> int A::bar <6:7 6:9>"));
}
...
TEST_CASE("cxx parser finds usage of field in function call context") {
  ...
  REQUIRE(utility::containsElement<std::wstring>(client->usages, L"void A::foo(int) -> A * A::a <6:3 6:3>"));
}
...
TEST_CASE("cxx parser finds usage of field in initialization list") {
  ...
  REQUIRE(utility::containsElement<std::wstring>(client->usages, L"void App::App() -> int App::bar <4:5 4:7>"));
}
...
TEST_CASE("cxx parser finds usage of member in call expression to unresolved member expression") {
  ...
  REQUIRE(utility::containsElement<std::wstring>(client->usages, L"T B::run<typename T>() -> A B::a <8:10 8:10>"));
}
...
TEST_CASE("cxx parser finds usage of member in temporary object expression") {
  ...
  REQUIRE(
      utility::containsElement<std::wstring>(client->usages, L"void Bar::baba() -> const Foo Bar::m_i <15:7 15:9>"));
}
...
TEST_CASE("cxx parser finds usage of member in dependent scope member expression") {
  ...
  REQUIRE(utility::containsElement<std::wstring>(client->usages,
                                                 L"void A<typename T>::foo() -> T A<typename T>::m_t <8:3 8:5>"));
}
...
TEST_CASE("cxx parser finds return type use in function") {
  ...
  REQUIRE(utility::containsElement<std::wstring>(client->typeUses, L"double PI() -> double <1:1 1:6>"));
}
...
TEST_CASE("cxx parser finds parameter type uses in function") {
  ...
  REQUIRE(utility::containsElement<std::wstring>(client->typeUses, L"void ceil(float) -> float <1:11 1:15>"));
}
...
TEST_CASE("cxx parser finds use of decayed parameter type in function") {
  ...
  REQUIRE(utility::containsElement<std::wstring>(client->localSymbols, L"input.cc<1:16> <5:13 5:13>"));
  REQUIRE(utility::containsElement<std::wstring>(client->localSymbols, L"input.cc<1:32> <5:22 5:22>"));
}
...
TEST_CASE("cxx parser finds use of qualified type in function") {
  ...
  REQUIRE(utility::containsElement<std::wstring>(client->typeUses, L"void test(const int) -> int <1:17 1:19>"));
}
...
TEST_CASE("cxx parser finds parameter type uses in constructor") {
  ...
  REQUIRE(utility::containsElement<std::wstring>(client->typeUses, L"void A::A(int) -> int <3:4 3:6>"));
}
...
TEST_CASE("cxx parser finds type uses in function body") {
  ...
  REQUIRE(utility::containsElement<std::wstring>(client->typeUses, L"int main() -> int <3:2 3:4>"));
}
...
TEST_CASE("cxx parser finds type uses in method body") {
  ...
  REQUIRE(utility::containsElement<std::wstring>(client->typeUses, L"int A::main() -> int <5:3 5:5>"));
}
...
TEST_CASE("cxx parser finds type uses in loops and conditions") {
  ...
  REQUIRE(utility::containsElement<std::wstring>(client->typeUses, L"int main() -> int <5:3 5:5>"));
  REQUIRE(utility::containsElement<std::wstring>(client->typeUses, L"int main() -> int <7:7 7:9>"));
  REQUIRE(utility::containsElement<std::wstring>(client->typeUses, L"int main() -> int <9:3 9:5>"));
}
...
TEST_CASE("cxx parser finds enum uses in function body") {
  ...
  REQUIRE(utility::containsElement<std::wstring>(client->typeUses, L"int main() -> A <9:16 9:16>"));
}
...
TEST_CASE("cxx parser finds usage of template parameters with different depth of template function") {
  ...
  REQUIRE(utility::containsElement<std::wstring>(client->localSymbols, L"input.cc<1:20> <7:3 7:3>"));
  REQUIRE(utility::containsElement<std::wstring>(client->localSymbols, L"input.cc<4:21> <5:11 5:11>"));
}
...
TEST_CASE(
  ...
  REQUIRE(utility::containsElement<std::wstring>(client->localSymbols, L"input.cc<1:20> <13:3 13:3>"));
  REQUIRE(utility::containsElement<std::wstring>(client->localSymbols, L"input.cc<10:21> <13:9 13:9>"));
}
...
TEST_CASE(
  ...
  REQUIRE(utility::containsElement<std::wstring>(client->localSymbols, L"input.cc<4:36> <7:11 7:11>"));
}
...
TEST_CASE(
  ...
  REQUIRE(utility::containsElement<std::wstring>(client->localSymbols, L"input.cc<4:36> <8:11 8:11>"));
}
...
TEST_CASE("cxx parser finds typedef in other class that depends on own template parameter") {
  ...
  REQUIRE(utility::containsElement<std::wstring>(client->typeUses, L"A<int>::type -> int <5:10 5:10>"));
  REQUIRE(utility::containsElement<std::wstring>(client->typeUses,
                                                 L"B<typename U>::type -> A<typename T>::type <11:25 11:28>"));
  REQUIRE(utility::containsElement<std::wstring>(client->typeUses, L"B<int>::type -> A<int>::type <11:25 11:28>"));
  REQUIRE(utility::containsElement<std::wstring>(client->typeUses, L"B<int>::type f -> B<int>::type <13:9 13:12>"));
}
...
TEST_CASE("cxx parser finds usage of template parameter in qualifier of other symbol") {
  ...
  REQUIRE(utility::containsElement<std::wstring>(client->localSymbols, L"input.cc<4:20> <8:49 8:49>"));
}
...
TEST_CASE("cxx parser finds use of dependent template specialization type") {
  ...
  REQUIRE(utility::containsElement<std::wstring>(client->typeUses,
                                                 L"B<typename U>::type -> A<typename T>::type<float> <12:10 12:17>"));
  REQUIRE(utility::containsElement<std::wstring>(client->typeUses, L"B<bool>::type f -> B<bool>::type <14:10 14:13>"));
}
...
TEST_CASE(
  ...
  REQUIRE(utility::containsElement<std::wstring>(client->functions,
                                                 L"int adder<int, <...>>(int, ...) <5:1 <5:1 <5:3 5:7> 5:30> 5:65>"));
  REQUIRE(utility::containsElement<std::wstring>(
...
TEST_CASE("cxx parser finds type template argument of explicit template instantiation") {
  ...
  REQUIRE(utility::containsElement<std::wstring>(client->typeUses, L"int main() -> int <7:4 7:6>"));
}
...
TEST_CASE(
  ...
  REQUIRE(utility::containsElement<std::wstring>(client->typeUses, L"A<int()> -> int <7:4 7:6>"));
  REQUIRE(utility::containsElement<std::wstring>(client->typeUses, L"void foo() -> int <7:4 7:6>"));
  REQUIRE(utility::containsElement<std::wstring>(client->typeUses, L"void foo() -> int <7:4 7:6>"));
}

TEST_CASE("cxx parser finds type template argument for parameter pack of explicit template instantiation") {
  std::shared_ptr<TestStorage> client = parseCode(
      "template <typename... T>\n"
      "class A\n"
      "{\n"
  ...
  REQUIRE(utility::containsElement<std::wstring>(client->typeUses, L"A<<...>> -> float <7:11 7:15>"));
  REQUIRE(utility::containsElement<std::wstring>(client->typeUses, L"int main() -> int <7:6 7:8>"));
  REQUIRE(utility::containsElement<std::wstring>(client->typeUses, L"int main() -> float <7:11 7:15>"));
  REQUIRE(utility::containsElement<std::wstring>(client->typeUses, L"int main() -> int <7:6 7:8>"));
  REQUIRE(utility::containsElement<std::wstring>(client->typeUses, L"int main() -> float <7:11 7:15>"));
}
...
TEST_CASE(
  ...
  REQUIRE(utility::containsElement<std::wstring>(client->typeUses, L"int main() -> int <9:4 9:6>"));
  REQUIRE(utility::containsElement<std::wstring>(client->typeUses, L"int main() -> int <9:4 9:6>"));
}
...
TEST_CASE("cxx parser finds type template argument in new expression of explicit template instantiation") {
  std::shared_ptr<TestStorage> client = parseCode(
      "template <typename T>\n"
      "class A\n"
      "{\n"
  ...
  REQUIRE(utility::containsElement<std::wstring>(client->typeUses, L"int main() -> int <9:8 9:10>"));
  REQUIRE(utility::containsElement<std::wstring>(client->typeUses, L"int main() -> int <9:8 9:10>"));
}
...
TEST_CASE("cxx parser finds non type custom pointer template argument of implicit template instantiation") {
  std::shared_ptr<TestStorage> client = parseCode(
      "class P\n"
      "{};\n"
      "template <P* p>\n"
...
TEST_CASE("cxx parser finds template template argument of explicit template instantiation") {
  ...
  REQUIRE(utility::containsElement<std::wstring>(client->typeUses, L"B<A> -> A<typename T> <9:4 9:4>"));
  REQUIRE(utility::containsElement<std::wstring>(client->typeUses, L"int main() -> A<typename T> <9:4 9:4>"));
}
...
TEST_CASE(
  ...
  REQUIRE(utility::containsElement<std::wstring>(client->typeUses, L"B<<...>> -> A<typename T> <11:4 11:4>"));
  REQUIRE(utility::containsElement<std::wstring>(client->typeUses, L"B<<...>> -> A<typename T> <11:7 11:7>"));
  REQUIRE(utility::containsElement<std::wstring>(client->typeUses, L"int main() -> A<typename T> <11:4 11:4>"));
  REQUIRE(utility::containsElement<std::wstring>(client->typeUses, L"int main() -> A<typename T> <11:7 11:7>"));
}

TEST_CASE("cxx parser finds template argument for implicit specialization of global template variable") {
  std::shared_ptr<TestStorage> client = parseCode(
      "template <typename T>\n"
      "T v;\n"
      "void test()\n"
  ...
  REQUIRE(utility::containsElement<std::wstring>(client->typeUses, L"int v<int> -> int <5:4 5:6>"));
  REQUIRE(utility::containsElement<std::wstring>(client->typeUses, L"void test() -> int <5:4 5:6>"));
}
...
TEST_CASE(
  ...
  REQUIRE(utility::containsElement<std::wstring>(client->templateSpecializations,
                                                 L"int A<int>::foo() -> T A<typename T>::foo() <5:4 5:6>"));
}
...
TEST_CASE("cxx parser finds template member specialization for field of implicit template specialization") {
  std::shared_ptr<TestStorage> client = parseCode(
      "template <typename T>\n"
      "class A\n"
      "{\n"
...
TEST_CASE(
  ...
  REQUIRE(utility::containsElement<std::wstring>(client->templateSpecializations,
                                                 L"A<int>::B -> A<typename T>::B <5:8 5:8>"));
}
...
TEST_CASE(
  ...
  REQUIRE(utility::containsElement<std::wstring>(client->typeUses, L"A<&g_p> -> P g_p <8:10 8:12>"));
}
...
TEST_CASE("cxx parser finds template template argument of explicit template specialization") {
  ...
  REQUIRE(utility::containsElement<std::wstring>(client->typeUses, L"B<A> -> A<typename T> <8:9 8:9>"));
}

TEST_CASE("cxx parser finds type template arguments of explicit partial class template specialization") {
  std::shared_ptr<TestStorage> client = parseCode(
      "template <typename T, typename U>\n"
      "class A\n"
      "{\n"
  ...
  REQUIRE(utility::containsElement<std::wstring>(client->localSymbols, L"input.cc<5:20> <6:9 6:9>"));
  REQUIRE(utility::containsElement<std::wstring>(client->typeUses, L"A<typename T, int> -> int <6:12 6:14>"));
}
...
TEST_CASE(
  ...
  REQUIRE(utility::containsElement<std::wstring>(client->localSymbols, L"input.cc<5:15> <6:12 6:12>"));
}
...
TEST_CASE(
  ...
  REQUIRE(utility::containsElement<std::wstring>(client->localSymbols, L"input.cc<5:16> <6:15 6:15>"));
}
...
TEST_CASE(
  ...
  REQUIRE(utility::containsElement<std::wstring>(client->localSymbols, L"input.cc<7:14> <8:15 8:15>"));
}
...
TEST_CASE(
  ...
  REQUIRE(utility::containsElement<std::wstring>(client->typeUses, L"A<g_p, q> -> P g_p <8:9 8:11>"));
  REQUIRE(utility::containsElement<std::wstring>(client->localSymbols, L"input.cc<7:14> <8:14 8:14>"));
}
...
TEST_CASE(
  ...
  REQUIRE(utility::containsElement<std::wstring>(client->typeUses,
                                                 L"B<A, template<typename> typename U> -> A<typename T> <8:9 8:9>"));
  REQUIRE(utility::containsElement<std::wstring>(client->localSymbols, L"input.cc<7:36> <8:12 8:12>"));
}
...
TEST_CASE(
  ...
  REQUIRE(utility::containsElement<std::wstring>(client->localSymbols, L"input.cc<5:27> <6:16 6:17>"));
}
...
TEST_CASE(
  ...
  REQUIRE(utility::containsElement<std::wstring>(client->localSymbols, L"input.cc<5:36> <6:12 6:13>"));
  REQUIRE(utility::containsElement<std::wstring>(client->localSymbols, L"input.cc<5:48> <6:16 6:17>"));
}
...
TEST_CASE("cxx parser finds implicit template class specialization") {
  ...
  REQUIRE(
      utility::containsElement<std::wstring>(client->templateSpecializations, L"A<int> -> A<typename T> <2:7 2:7>"));
}
...
TEST_CASE("cxx parser finds class inheritance from implicit template class specialization") {
  ...
  REQUIRE(utility::containsElement<std::wstring>(client->inheritances, L"B -> A<int> <7:17 7:17>"));
}
...
TEST_CASE("record base class of implicit template class specialization") {
  ...
  REQUIRE(utility::containsElement<std::wstring>(client->inheritances,
                                                 L"Vector2<float> -> VectorBase<float, 2> <5:24 5:33>"));
}
...
TEST_CASE("cxx parser finds template class specialization with template argument") {
  ...
  REQUIRE(utility::containsElement<std::wstring>(client->localSymbols, L"input.cc<7:20> <8:19 8:19>"));
...
TEST_CASE(
  ...
  REQUIRE(utility::containsElement<std::wstring>(client->classes,
                                                 L"vector<class Foo2, class Foo1, int> <3:1 <4:7 4:12> 4:33>"));
}
...
TEST_CASE(
  ...
  REQUIRE(utility::containsElement<std::wstring>(client->classes,
                                                 L"vector<class Foo1, A<typename T>> <5:1 <6:7 6:12> 6:31>"));
}
...
TEST_CASE(
  ...
  REQUIRE(utility::containsElement<std::wstring>(client->classes,
                                                 L"foo<typename T0>::vector<arg0_0, class T1> <5:2 <6:8 6:13> 6:25>"));
}
...
TEST_CASE("cxx parser finds template class constructor usage of field") {
  ...
  REQUIRE(utility::containsElement<std::wstring>(client->usages,
                                                 L"void A<typename T>::A<T>() -> T A<typename T>::foo <4:7 4:9>"));
}
...
TEST_CASE("cxx parser finds correct method return type of template class in declaration") {
  ...
  REQUIRE(
      utility::containsElement<std::wstring>(client->methods, L"private T A<typename T>::foo() <4:2 <4:4 4:6> 4:8>"));
}
...
TEST_CASE("cxx parser finds type template default argument type of template class") {
  ...
  REQUIRE(utility::containsElement<std::wstring>(client->typeUses, L"A<typename T> -> int <1:24 1:26>"));
}
...
TEST_CASE("cxx parser finds template template default argument type of template class") {
  ...
  REQUIRE(utility::containsElement<std::wstring>(client->typeUses,
                                                 L"B<template<typename> typename T> -> A<typename T> <4:40 4:40>"));
}
...
TEST_CASE("cxx parser finds implicit instantiation of template function") {
  ...
  REQUIRE(utility::containsElement<std::wstring>(client->templateSpecializations,
                                                 L"int test<int>(int) -> T test<typename T>(T) <2:3 2:6>"));
}
...
TEST_CASE("cxx parser finds explicit specialization of template function") {
  ...
  REQUIRE(utility::containsElement<std::wstring>(client->templateSpecializations,
                                                 L"int test<int>(int) -> T test<typename T>(T) <8:5 8:8>"));
}
...
TEST_CASE(
  ...
  REQUIRE(utility::containsElement<std::wstring>(client->typeUses, L"void test<int>() -> int <7:11 7:13>"));
}
...
TEST_CASE("cxx parser finds explicit type template argument of function call in function") {
  ...
  REQUIRE(utility::containsElement<std::wstring>(client->typeUses, L"void test<int>() -> int <6:7 6:9>"));
}

TEST_CASE("cxx parser finds no explicit non type int template argument of function call in function") {
  std::shared_ptr<TestStorage> client = parseCode(
      "template <int T>\n"  // use of "int"
      "void test(){}\n"     // 2x use of "void"
      "\n"
...
TEST_CASE("cxx parser finds explicit template template argument of function call in function") {
  ...
  REQUIRE(utility::containsElement<std::wstring>(client->typeUses, L"void test<A>() -> A<typename T> <7:7 7:7>"));
}
...
TEST_CASE("cxx parser finds explicit type template argument of function call in var decl") {
  ...
  REQUIRE(utility::containsElement<std::wstring>(client->typeUses, L"int test<int>() -> int <6:17 6:19>"));
}
...
TEST_CASE("cxx parser finds type template default argument type of template function") {
  ...
  REQUIRE(utility::containsElement<std::wstring>(client->typeUses, L"void test<typename T>() -> int <1:24 1:26>"));
}
...
TEST_CASE("cxx parser finds lambda calling a function") {
  ...
  REQUIRE(utility::containsElement<std::wstring>(client->calls,
                                                 L"void lambdaCaller::lambda at 4:2() const -> void func() <6:3 6:6>"));
}
...
TEST_CASE("cxx parser finds local variable in lambda capture") {
  ...
  REQUIRE(utility::containsElement<std::wstring>(client->localSymbols, L"input.cc<3:6> <4:3 4:3>"));
}
...
TEST_CASE("cxx parser finds usage of local variable in microsoft inline assembly statement") {
  ...
  REQUIRE(utility::containsElement<std::wstring>(client->localSymbols, L"input.cc<3:6> <6:11 6:11>"));

  REQUIRE(utility::containsElement<std::wstring>(client->localSymbols, L"input.cc<3:6> <7:6 7:6>"));
}
...
TEST_CASE("cxx parser finds template argument of unresolved lookup expression") {
  ...
  REQUIRE(utility::containsElement<std::wstring>(client->localSymbols, L"input.cc<6:20> <9:4 9:14>"));
}
...
TEST_CASE("cxx parser finds correct location of explicit constructor defined in namespace") {
  ...
  REQUIRE(utility::containsElement<std::wstring>(client->calls, L"int main() -> void n::App::App(int) <11:16 11:18>"));
}
...
TEST_CASE(
  ...
  REQUIRE(utility::containsElement<std::wstring>(client->fields, L"private int A::m_value <3:16 3:22>"));
}
...
TEST_CASE(
  ...
  REQUIRE(utility::containsElement<std::wstring>(client->fields, L"private int A::m_value <3:2 3:14>"));
}
...
TEST_CASE(
  ...
  REQUIRE(utility::containsElement<std::wstring>(client->calls, L"int A::m_value -> int foo() <4:25 4:27>"));
}
...
TEST_CASE("cxx parser finds macro usage location for function call in code of macro body") {
  ...
  REQUIRE(utility::containsElement<std::wstring>(client->calls, L"int A::m_value -> int foo() <4:2 4:14>"));
}
...
TEST_CASE("cxx parser finds type template argument of static cast expression") {
  ...
  REQUIRE(utility::containsElement<std::wstring>(client->typeUses, L"int main() -> int <3:21 3:23>"));
}
...
TEST_CASE("cxx parser finds implicit constructor call in initialization") {
  ...
  REQUIRE(utility::containsElement<std::wstring>(client->calls, L"void B::B() -> void A::A() <6:2 6:2>"));
}
...
TEST_CASE("cxx parser parses multiple files") {
  ...
  std::shared_ptr<IndexerCommandCxx> indexerCommand = std::make_shared<IndexerCommandCxx>(
      sourceFilePath, indexedPaths, excludeFilters, includeFilters, workingDirectory,
...
TEST_CASE("cxx parser finds braces of class decl") {
  ...
  REQUIRE(utility::containsElement<std::wstring>(client->localSymbols, L"input.cc<2:1> <2:1 2:1>"));
  REQUIRE(utility::containsElement<std::wstring>(client->localSymbols, L"input.cc<2:1> <3:1 3:1>"));
}
...
TEST_CASE("cxx parser finds braces of method decl") {
  ...
  REQUIRE(utility::containsElement<std::wstring>(client->localSymbols, L"input.cc<4:13> <4:13 4:13>"));
  REQUIRE(utility::containsElement<std::wstring>(client->localSymbols, L"input.cc<4:13> <4:14 4:14>"));
}
...
TEST_CASE("cxx parser finds braces of init list") {
  ...
  REQUIRE(utility::containsElement<std::wstring>(client->localSymbols, L"input.cc<2:11> <2:11 2:11>"));
  REQUIRE(utility::containsElement<std::wstring>(client->localSymbols, L"input.cc<2:11> <2:13 2:13>"));
}
...
TEST_CASE("cxx parser finds braces of lambda") {
  ...
  REQUIRE(utility::containsElement<std::wstring>(client->localSymbols, L"input.cc<3:6> <3:6 3:6>"));
  REQUIRE(utility::containsElement<std::wstring>(client->localSymbols, L"input.cc<3:6> <3:7 3:7>"));
}
...
TEST_CASE("cxx parser finds braces of asm stmt") {
  ...
  REQUIRE(utility::containsElement<std::wstring>(client->localSymbols, L"input.cc<4:2> <4:2 4:2>"));
  REQUIRE(utility::containsElement<std::wstring>(client->localSymbols, L"input.cc<4:2> <6:2 6:2>"));
}
...
TEST_CASE("cxx parser finds braces with closing bracket in macro") {
  ...
  REQUIRE(utility::containsElement<std::wstring>(client->localSymbols, L"input.cc<3:1> <3:1 3:1>"));
  REQUIRE(utility::containsElement<std::wstring>(client->localSymbols, L"input.cc<3:1> <7:2 7:2>"));
  ...
  REQUIRE(utility::containsElement<std::wstring>(client->localSymbols, L"input.cc<7:1> <7:1 7:1>"));
...
TEST_CASE("cxx parser finds correct signature location of constructor with initializer list") {
  ...
  REQUIRE(utility::containsElement<std::wstring>(client->methods,
                                                 L"private void A::A(const int &) <3:2 <3:2 <3:2 3:2> 3:18> 5:2>"));
}

TEST_CASE("cxx parser catches error") {
  std::shared_ptr<TestStorage> client = parseCode("int a = b;\n");

  REQUIRE(utility::containsElement<std::wstring>(client->errors, L"use of undeclared identifier \'b\' <1:9 1:9>"));
}

TEST_CASE("cxx parser catches error in force include") {
  std::shared_ptr<TestStorage> client = parseCode("void foo() {} \n", {L"-include nothing"});

  REQUIRE(utility::containsElement<std::wstring>(client->errors, L"' nothing' file not found <1:1 1:1>"));
}
...
TEST_CASE("cxx parser finds correct error location after line directive") {
  ...
  REQUIRE(utility::containsElement<std::wstring>(client->errors,
                                                 L"expected function body after function declarator <2:11 2:11>"));
}
...
TEST_CASE("cxx parser catches error in macro expansion") {
  ...
  REQUIRE(utility::containsElement<std::wstring>(client->errors,
                                                 L"'this_path_does_not_exist.txt' file not found <2:10 2:10>"));
}
