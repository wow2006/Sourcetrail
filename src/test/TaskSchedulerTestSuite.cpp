...
class TestTask : public Task {
 public:
  ...
  virtual void doEnter(std::shared_ptr<Blackboard> blackboard) { enterCallOrder = ++orderCount; }
  ...
  virtual void doExit(std::shared_ptr<Blackboard> blackboard) { exitCallOrder = ++orderCount; }

  virtual void doReset(std::shared_ptr<Blackboard> blackboard) { resetCallOrder = ++orderCount; }
