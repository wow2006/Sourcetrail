...
TEST_CASE("shared memory", "[lib]") { //NOLINT(readability-function-cognitive-complexity)
  constexpr auto MemoryName = "memory";
  constexpr auto InitialMemorySize = 1000;
  SharedMemory memory(MemoryName, InitialMemorySize, SharedMemory::CREATE_AND_DELETE);
