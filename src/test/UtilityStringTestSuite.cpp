...
TEST_CASE("split with char delimiter", "[utility][string]") { // NOLINT(readability-function-cognitive-complexity)
  SECTION("empty input") {
...
TEST_CASE("split with string delimiter", "[utility][string]") { // NOLINT(readability-function-cognitive-complexity)
  SECTION("goodcase") {
...
TEST_CASE("split with string delimiter to vector", "[utility][string]") { // NOLINT(readability-function-cognitive-complexity)
  SECTION("goodcase") {
...
TEST_CASE("join with char delimiter", "[utility][string]") { // NOLINT(readability-function-cognitive-complexity)
  SECTION("goodcase") {
...
TEST_CASE("tokenize with string", "[utility][string]") { // NOLINT(readability-function-cognitive-complexity)
...
TEST_CASE("substr", "[utility][string]") { // NOLINT(readability-function-cognitive-complexity)
  ...
  SECTION("before first with delimiter at start") { REQUIRE(utility::substrBeforeFirst(" foobar", ' ').empty()); }
  ...
  SECTION("before last with delimiter at start") { REQUIRE(utility::substrBeforeLast(" foobar", ' ').empty()); }
  ...
  SECTION("after with delimiter at end") { REQUIRE(utility::substrAfter("foobar ", ' ').empty()); }
...
TEST_CASE("caseInsensitiveLess", "[utility][string]") { // NOLINT(readability-function-cognitive-complexity)
...
TEST_CASE("elide", "[utility][string]") {
