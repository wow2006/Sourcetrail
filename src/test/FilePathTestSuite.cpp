...
TEST_CASE("file_path_gets_created_empty", "[lib]") {
  const FilePath path;

  REQUIRE(path.wstr() == L"");
}

TEST_CASE("file_path_gets_created_with_string", "[lib]") {
...
TEST_CASE("file_path_gets_created_other_file_path", "[lib]") {
...
TEST_CASE("file_path_exists", "[lib]") {
  const FilePath path(L"data/FilePathTestSuite/a.cpp");

  REQUIRE(path.exists());
}

TEST_CASE("file_path_not_exists", "[lib]") {
  const FilePath path(L"data/FilePathTestSuite/a.h");

  REQUIRE(!path.exists());
}

TEST_CASE("file_path_is_directory", "[lib]") {
  const FilePath path(L"data/FilePathTestSuite/a.cpp");
...
TEST_CASE("empty_file_path_has_empty_parent_directory", "[lib]") {
  const FilePath path;
...
TEST_CASE("file_path_without_parent_has_empty_parent_directory", "[lib]") {
  const FilePath path(L"a.cpp");

  REQUIRE(path.getParentDirectory().empty());
}

TEST_CASE("file_path_is_absolute", "[lib]") {
  const FilePath path(L"data/FilePathTestSuite/a.cpp");
...
TEST_CASE("file_path_parent_directory", "[lib]") {
  const FilePath path(L"data/FilePathTestSuite/a.cpp");
...
TEST_CASE("file_path_relative_to_other_path", "[lib]") {
...
TEST_CASE("file_path_relative_to_other_directory", "[lib]") {
  const FilePath pathA(L"data/FilePathTestSuite/a.cpp");
...
TEST_CASE("file_path_equals_file_with_different_relative_paths", "[lib]") {
  const FilePath path1(L"data/FilePathTestSuite/a.cpp");
...
TEST_CASE("file_path_equals_relative_and_absolute_paths", "[lib]") {
  const FilePath path1(L"data/FilePathTestSuite/a.cpp");
...
TEST_CASE("file_path_equals_absolute_and_canonical_paths", "[lib]") {
  const FilePath path(L"data/../data/FilePathTestSuite/./a.cpp");

  REQUIRE(path.getAbsolute() == path.getCanonical());
}

TEST_CASE("file_path_canonical_removes_symlinks", "[lib]") {
#ifndef _WIN32
...
TEST_CASE("file_path_compares_paths_with_posix_and_windows_format", "[lib]") {
#ifdef _WIN32
...
TEST_CASE("file_path_differs_for_different_existing_files", "[lib]") {
  const FilePath pathA(L"data/FilePathTestSuite/a.cpp");
  const FilePath pathB(L"data/FilePathTestSuite/b.cc");
...
TEST_CASE("file_path_differs_for_different_nonexistent_files", "[lib]") {
...
TEST_CASE("file_path_differs_for_existing_and_nonexistent_files", "[lib]") {
  const FilePath pathA(L"data/FilePathTestSuite/a.h");
  const FilePath pathB(L"data/FilePathTestSuite/b.cc");
...
TEST_CASE("file path is valid for absolute and relative existing files and directories paths", "[lib]") {
...
// NOLINTNEXTLINE(readability-function-cognitive-complexity)
TEST_CASE("file path is valid for absolute and relative non-existing files and directories paths", "[lib]") {
...
TEST_CASE("file path is invalid for absolute and relative paths with invalid characters", "[lib]") {
