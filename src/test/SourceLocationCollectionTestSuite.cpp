...
TEST_CASE("source locations get created with other end")
{
	...
	const SourceLocation* a = collection.addSourceLocation(
		LOCATION_TOKEN, 1, {1}, utility::file::FilePath(L"file.c"), 2, 3, 4, 5);
...
TEST_CASE("source locations do not get created with wrong input")
{
	...
	SourceLocation* a = collection.addSourceLocation(
		LOCATION_TOKEN, 1, {1}, utility::file::FilePath(L"file.c"), 2, 3, 2, 1);
	SourceLocation* b = collection.addSourceLocation(
		LOCATION_TOKEN, 2, {1}, utility::file::FilePath(L"file.c"), 4, 1, 1, 10);
...
TEST_CASE("source locations get unique id but both ends have the same")
{
	SourceLocationCollection collection;
	SourceLocation* a = collection.addSourceLocation(
		LOCATION_TOKEN, 1, {1}, utility::file::FilePath(L"file.c"), 1, 1, 1, 1);
	SourceLocation* b = collection.addSourceLocation(
		LOCATION_TOKEN, 2, {2}, utility::file::FilePath(L"file.c"), 1, 1, 1, 1);
	SourceLocation* c = collection.addSourceLocation(
		LOCATION_TOKEN, 3, {3}, utility::file::FilePath(L"file.c"), 1, 1, 1, 1);
...
TEST_CASE("finding source locations by id")
{
	...
	SourceLocation* a = collection.addSourceLocation(
		LOCATION_TOKEN, 1, {1}, utility::file::FilePath(L"file.c"), 2, 3, 4, 5);
	SourceLocation* b = collection.addSourceLocation(
		LOCATION_TOKEN, 2, {6}, utility::file::FilePath(L"file.c"), 7, 8, 9, 10);
...
TEST_CASE("creating plain copy of all locations in line range")
{
	...
	SourceLocation* a = collection.addSourceLocation(
		LOCATION_TOKEN, 1, {1}, utility::file::FilePath(L"file.c"), 2, 3, 4, 5);
	SourceLocation* b = collection.addSourceLocation(
		LOCATION_TOKEN, 2, {1}, utility::file::FilePath(L"file.c"), 3, 3, 4, 5);
	SourceLocation* c = collection.addSourceLocation(
		LOCATION_TOKEN, 3, {1}, utility::file::FilePath(L"file.c"), 1, 3, 5, 5);
	SourceLocation* d = collection.addSourceLocation(
		LOCATION_TOKEN, 4, {1}, utility::file::FilePath(L"file.c"), 1, 5, 4, 5);
...
TEST_CASE("get source locations filtered by lines")
{
	SourceLocationCollection collection;
	SourceLocation* a = collection.addSourceLocation(
		LOCATION_TOKEN, 1, {1}, utility::file::FilePath(L"file.c"), 1, 3, 1, 5);
	SourceLocation* b = collection.addSourceLocation(
		LOCATION_TOKEN, 2, {1}, utility::file::FilePath(L"file.c"), 1, 3, 2, 5);
	SourceLocation* c = collection.addSourceLocation(
		LOCATION_TOKEN, 3, {1}, utility::file::FilePath(L"file.c"), 2, 3, 2, 5);
	SourceLocation* d = collection.addSourceLocation(
		LOCATION_TOKEN, 4, {1}, utility::file::FilePath(L"file.c"), 3, 3, 4, 5);
	SourceLocation* e = collection.addSourceLocation(
		LOCATION_TOKEN, 5, {1}, utility::file::FilePath(L"file.c"), 3, 5, 5, 5);
	SourceLocation* f = collection.addSourceLocation(
		LOCATION_TOKEN, 6, {1}, utility::file::FilePath(L"file.c"), 1, 5, 5, 5);
	SourceLocation* g = collection.addSourceLocation(
		LOCATION_TOKEN, 7, {1}, utility::file::FilePath(L"file.c"), 5, 5, 5, 5);
