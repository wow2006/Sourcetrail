...
int TestLogger::getMessageCount() const { return m_logMessageCount; }

int TestLogger::getWarningCount() const { return m_logWarningCount; }

int TestLogger::getErrorCount() const { return m_logErrorCount; }

std::wstring TestLogger::getLastInfo() const { return m_lastInfo; }

std::wstring TestLogger::getLastWarning() const { return m_lastWarning; }
...
void logSomeMessages(LogManagerImplementation* logManagerImplementation, const std::wstring& message,
