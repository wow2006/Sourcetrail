...
TEST_CASE("java parser finds anotation declaration in defaut package") {
  ...
  REQUIRE(
      utility::containsElement<std::wstring>(client->annotations, L"public SampleAnnotation <1:1 <1:19 1:34> 3:1>"));
}
...
TEST_CASE("java parser finds anotation member declaration") {
  ...
  REQUIRE(utility::containsElement<std::wstring>(client->fields, L"public int SampleAnnotation.value <3:13 3:17>"));
}
...
TEST_CASE("java parser finds class declaration in defaut package") {
  ...
  REQUIRE(utility::containsElement<std::wstring>(client->classes, L"public A <1:1 <1:14 1:14> 3:1>"));
}
...
TEST_CASE("java parser finds interface declaration in defaut package") {
  ...
  REQUIRE(utility::containsElement<std::wstring>(client->interfaces, L"public A <1:1 <1:18 1:18> 3:1>"));
}
...
TEST_CASE("java parser finds class declaration in named package") {
  ...
  REQUIRE(utility::containsElement<std::wstring>(client->classes, L"public foo.A <2:1 <2:14 2:14> 4:1>"));
}
...
TEST_CASE("java parser finds class declaration in nested named package") {
  ...
  REQUIRE(utility::containsElement<std::wstring>(client->classes, L"public foo.bar.A <2:1 <2:14 2:14> 4:1>"));
}
...
TEST_CASE("java parser finds enum declaration in named package") {
  ...
  REQUIRE(utility::containsElement<std::wstring>(client->enums, L"public foo.A <2:1 <2:13 2:13> 4:1>"));
}
...
TEST_CASE("java parser finds enum constant declaration") {
  ...
  REQUIRE(utility::containsElement<std::wstring>(client->enumConstants, L"foo.A.A_TEST <4:2 4:7>"));
}
...
TEST_CASE("java parser finds constructor declaration without parameters") {
  ...
  REQUIRE(utility::containsElement<std::wstring>(client->methods, L"public foo.A.A() <4:2 <4:2 <4:9 4:9> 4:11> 6:2>"));
}
...
TEST_CASE("java parser finds method declaration with custom type in signature") {
  ...
  REQUIRE(utility::containsElement<std::wstring>(client->methods,
                                                 L"public void foo.A.bar(foo.A) <4:2 <4:2 <4:14 4:16> 4:21> 6:2>"));
}
...
TEST_CASE("java parser finds method declaration with static keyword in signature") {
  ...
  REQUIRE(utility::containsElement<std::wstring>(client->methods,
                                                 L"public static void foo.A.bar() <4:2 <4:2 <4:21 4:23> 4:25> 6:2>"));
}
...
TEST_CASE("java parser finds field declaration with initial assignment") {
  ...
  REQUIRE(utility::containsElement<std::wstring>(client->fields, L"default int foo.A.bar <4:6 4:8>"));
}
...
TEST_CASE("java parser finds public access specifier in field declaration") {
  ...
  REQUIRE(utility::containsElement<std::wstring>(client->fields, L"public int foo.A.bar <4:13 4:15>"));
}
...
TEST_CASE("java parser finds protected access specifier in field declaration") {
  ...
  REQUIRE(utility::containsElement<std::wstring>(client->fields, L"protected int foo.A.bar <4:16 4:18>"));
}
...
TEST_CASE("java parser finds private access specifier in field declaration") {
  ...
  REQUIRE(utility::containsElement<std::wstring>(client->fields, L"private int foo.A.bar <4:14 4:16>"));
}
...
TEST_CASE("java parser finds static keyword in field declaration") {
  ...
  REQUIRE(utility::containsElement<std::wstring>(client->fields, L"default static int foo.A.bar <4:13 4:15>"));
}
...
TEST_CASE("java parser finds declaration of method parameter") {
  ...
  REQUIRE(utility::containsElement<std::wstring>(client->localSymbols, L"foo.A.bar<0> <4:15 4:15>"));
}
...
TEST_CASE("java parser finds declaration of type parameter of method") {
  ...
  REQUIRE(utility::containsElement<std::wstring>(client->typeParameters, L"A.foo<T>.T <3:10 3:10>"));
}
...
TEST_CASE("java parser finds field of interface to be implicitly static") {
  ...
  REQUIRE(utility::containsElement<std::wstring>(client->fields, L"default static int A.b <3:6 3:6>"));
}
...
TEST_CASE("java parser finds missing import as error") {
  ...
  REQUIRE(utility::containsElement<std::wstring>(client->errors, L"The import foo cannot be resolved <1:8 1:8>"));
}
...
TEST_CASE("java parser finds class declaration nested in class") {
  ...
  REQUIRE(utility::containsElement<std::wstring>(client->classes, L"public foo.bar.A.B <4:2 <4:15 4:15> 6:2>"));
}
...
TEST_CASE("java parser finds class declaration nested in method") {
  ...
  REQUIRE(utility::containsElement<std::wstring>(client->classes, L"default foo.bar.A.bar.B <6:3 <6:9 6:9> 8:3>"));
}
...
TEST_CASE("java parser finds usage of marker annotation") {
  ...
  REQUIRE(utility::containsElement<std::wstring>(client->annotationUses, L"Foo -> SampleAnnotation <5:2 5:17>"));
}
...
TEST_CASE("java parser finds usage of single member annotation") {
  ...
  REQUIRE(utility::containsElement<std::wstring>(client->annotationUses, L"Foo -> SampleAnnotation <6:2 6:17>"));
}
...
TEST_CASE("java parser finds usage of normal annotation") {
  ...
  REQUIRE(utility::containsElement<std::wstring>(client->annotationUses, L"Foo -> SampleAnnotation <7:2 7:17>"));
}
...
TEST_CASE("java parser finds usage of normal annotation member in initialization") {
  ...
  REQUIRE(utility::containsElement<std::wstring>(client->usages, L"Foo -> int SampleAnnotation.a <7:19 7:19>"));
}
...
TEST_CASE("java parser finds inheritance using extends keyword") {
  ...
  REQUIRE(utility::containsElement<std::wstring>(client->inheritances, L"foo.B -> foo.A <6:24 6:24>"));
}
...
TEST_CASE("java parser finds inheritance using implements keyword") {
  ...
  REQUIRE(utility::containsElement<std::wstring>(client->inheritances, L"foo.B -> foo.A <6:27 6:27>"));
}
...
TEST_CASE("java parser finds usage of string for var type") {
  ...
  REQUIRE(utility::containsElement<std::wstring>(client->typeUses, L"void A.foo() -> java.lang.String <4:3 4:5>"));
}
...
TEST_CASE("java parser finds type parameter in signature of method") {
  ...
  REQUIRE(utility::containsElement<std::wstring>(client->typeUses,
                                                 L"A<java.lang.Void> A<T>.foo(A<java.lang.Void>) -> A<T> <3:9 3:9>"));
  REQUIRE(utility::containsElement<std::wstring>(client->typeUses,
                                                 L"A<java.lang.Void> A<T>.foo(A<java.lang.Void>) -> A<T> <3:21 3:21>"));
}
...
TEST_CASE("parser finds usage of type defined in base class") {
  ...
  REQUIRE(
      utility::containsElement<std::wstring>(client->typeUses, L"Foo.Base.X Foo.Derived.x -> Foo.Base.X <7:10 7:10>"));
}
...
TEST_CASE("java parser finds correct location of qualified type usage") {
  ...
  REQUIRE(utility::containsElement<std::wstring>(client->typeUses, L"void A.bar() -> A.B <8:5 8:5>"));
}
...
TEST_CASE("java parser finds type argument of parameterized type") {
  ...
  REQUIRE(utility::containsElement<std::wstring>(client->typeArguments, L"A<T> -> java.lang.Void <6:5 6:8>"));

  REQUIRE(utility::containsElement<std::wstring>(client->typeUses, L"void B.foo() -> java.lang.Void <6:5 6:8>"));
}
...
TEST_CASE("java parser finds type argument of method invocation") {
  ...
  REQUIRE(utility::containsElement<std::wstring>(client->typeArguments,
                                                 L"static void foo.X.foo() -> java.lang.Void <8:10 8:13>"));

  REQUIRE(utility::containsElement<std::wstring>(client->typeUses,
                                                 L"static void foo.X.bar() -> java.lang.Void <8:10 8:13>"));
}
...
TEST_CASE("java parser finds type argument of super method invocation") {
  ...
  REQUIRE(utility::containsElement<std::wstring>(client->typeArguments,
                                                 L"void foo.X.A.bar() -> java.lang.Void <15:11 15:14>"));

  REQUIRE(
      utility::containsElement<std::wstring>(client->typeUses, L"void foo.X.B.bar() -> java.lang.Void <15:11 15:14>"));
}
...
TEST_CASE("java parser finds type argument of constructor invocation") {
  ...
  REQUIRE(
      utility::containsElement<std::wstring>(client->typeArguments, L"foo.Bar.Bar() -> java.lang.Void <10:4 10:7>"));

  REQUIRE(utility::containsElement<std::wstring>(client->typeUses, L"foo.Bar.Bar(int) -> java.lang.Void <10:4 10:7>"));
}
...
TEST_CASE("java parser finds type argument of super constructor invocation") {
  ...
  REQUIRE(
      utility::containsElement<std::wstring>(client->typeArguments, L"A.Base.Base() -> java.lang.Void <11:5 11:8>"));

  REQUIRE(
      utility::containsElement<std::wstring>(client->typeUses, L"A.Derived.Derived() -> java.lang.Void <11:5 11:8>"));
}
...
TEST_CASE("java parser finds type argument of creation reference") {
  ...
  REQUIRE(utility::containsElement<std::wstring>(client->typeArguments, L"A.B.B() -> java.lang.Void <14:24 14:27>"));

  REQUIRE(utility::containsElement<std::wstring>(client->typeUses, L"void A.foo() -> java.lang.Void <14:24 14:27>"));
}
...
TEST_CASE("java parser finds type argument of expression method reference") {
  ...
  REQUIRE(utility::containsElement<std::wstring>(client->typeArguments,
                                                 L"static void A.bar() -> java.lang.Void <14:24 14:27>"));
...
TEST_CASE("java parser finds type argument of super method reference") {
  ...
  REQUIRE(utility::containsElement<std::wstring>(client->typeArguments,
                                                 L"void A.B.bar<T>() -> java.lang.Void <13:29 13:32>"));

  REQUIRE(utility::containsElement<std::wstring>(client->typeUses, L"void A.C.foo() -> java.lang.Void <13:29 13:32>"));
}
...
TEST_CASE("java parser finds type argument of type method reference") {
  ...
  REQUIRE(utility::containsElement<std::wstring>(client->typeUses, L"void A.foo() -> java.lang.Void <4:29 4:32>"));
}
...
TEST_CASE("java parser finds type argument of class instance creation") {
  ...
  REQUIRE(utility::containsElement<std::wstring>(client->typeArguments, L"A.B.B<T>() -> java.lang.Void <10:15 10:18>"));

  REQUIRE(utility::containsElement<std::wstring>(client->typeUses, L"void A.B.bar() -> java.lang.Void <10:15 10:18>"));
}
...
TEST_CASE("java parser finds super method invocation") {
  ...
  REQUIRE(
      utility::containsElement<std::wstring>(client->calls, L"void foo.X.B.bar() -> void foo.X.A.bar() <15:10 15:12>"));
}
...
TEST_CASE("java parser finds constructor invocation") {
  ...
  REQUIRE(utility::containsElement<std::wstring>(client->calls, L"foo.Bar.Bar(int) -> foo.Bar.Bar() <10:3 10:6>"));
}
...
TEST_CASE("java parser finds super constructor invocation") {
  ...
  REQUIRE(utility::containsElement<std::wstring>(client->calls, L"A.Derived.Derived() -> A.Base.Base() <11:4 11:8>"));
}
...
TEST_CASE("java parser finds overridden method with same signature") {
  ...
  REQUIRE(utility::containsElement<std::wstring>(client->overrides,
                                                 L"void Main.C.foo(int) -> void Main.Interfaze.foo(int) <7:15 7:17>"));
}
...
TEST_CASE("java parser finds method usage for creation reference") {
  ...
  REQUIRE(utility::containsElement<std::wstring>(client->usages, L"void A.foo() -> A.B.B() <14:23 14:25>"));
}
...
TEST_CASE("java parser finds method usage for expression method reference") {
  ...
  REQUIRE(utility::containsElement<std::wstring>(client->usages, L"void A.foo() -> void A.B.bar() <17:23 17:25>"));
}
...
TEST_CASE("java parser finds method usage for super method reference") {
  ...
  REQUIRE(utility::containsElement<std::wstring>(client->usages, L"void A.C.foo() -> void A.B.bar() <13:28 13:30>"));
}
...
TEST_CASE("java parser finds usage of field with same name as method parameter") {
  ...
  REQUIRE(utility::containsElement<std::wstring>(client->usages, L"foo.X.X(int) -> int foo.X.t <7:8 7:8>"));
}
...
TEST_CASE("java parser does not confuse method name with field name") {
  ...
  REQUIRE(utility::containsElement<std::wstring>(client->usages, L"void foo.X.foo() -> int foo.X.foo <7:8 7:10>"));
}
...
TEST_CASE("java parser finds scope of class declaration") {
  ...
  REQUIRE(utility::containsElement<std::wstring>(client->localSymbols, L"input.java<2:1> <2:1 2:1>"));
  REQUIRE(utility::containsElement<std::wstring>(client->localSymbols, L"input.java<2:1> <3:1 3:1>"));
}
...
TEST_CASE("java parser finds scope of constructor declaration") {
  ...
  REQUIRE(utility::containsElement<std::wstring>(client->localSymbols, L"input.java<4:2> <4:2 4:2>"));
  REQUIRE(utility::containsElement<std::wstring>(client->localSymbols, L"input.java<4:2> <5:2 5:2>"));
}
...
TEST_CASE("java parser finds scope of switch statement") {
  ...
  REQUIRE(utility::containsElement<std::wstring>(client->localSymbols, L"input.java<6:3> <6:3 6:3>"));
  REQUIRE(utility::containsElement<std::wstring>(client->localSymbols, L"input.java<6:3> <9:3 9:3>"));
}
...
TEST_CASE("java parser finds scope of block statement") {
  ...
  REQUIRE(utility::containsElement<std::wstring>(client->localSymbols, L"input.java<5:3> <5:3 5:3>"));
  REQUIRE(utility::containsElement<std::wstring>(client->localSymbols, L"input.java<5:3> <6:3 6:3>"));
}
...
TEST_CASE("java parser finds scope of array initialization list") {
  ...
  REQUIRE(utility::containsElement<std::wstring>(client->localSymbols, L"input.java<3:24> <3:24 3:24>"));
  REQUIRE(utility::containsElement<std::wstring>(client->localSymbols, L"input.java<3:24> <3:29 3:29>"));
}
...
TEST_CASE("java parser finds scope of anonymous class declaration") {
  ...
  REQUIRE(utility::containsElement<std::wstring>(client->localSymbols, L"input.java<10:3> <10:3 10:3>"));
  REQUIRE(utility::containsElement<std::wstring>(client->localSymbols, L"input.java<10:3> <11:3 11:3>"));
}
...
TEST_CASE("java parser finds usage of type parameter of class") {
  ...
  REQUIRE(utility::containsElement<std::wstring>(client->typeUses, L"A<T>.T A<T>.t -> A<T>.T <3:2 3:2>"));
}
...
TEST_CASE("java parser finds usage of type parameter of method") {
  ...
  REQUIRE(utility::containsElement<std::wstring>(client->typeUses, L"void A.foo<T>(T) -> A.foo<T>.T <3:22 3:22>"));
}
...
TEST_CASE("java parser finds correct location of generic type usage") {
  ...
  REQUIRE(utility::containsElement<std::wstring>(client->typeUses, L"A<java.lang.Void> A<T>.t -> A<T> <3:2 3:2>"));
}
...
TEST_CASE("java parser finds bound type of type parameter") {
  ...
  REQUIRE(utility::containsElement<std::wstring>(client->typeUses, L"A<T>.T -> java.lang.Void <1:27 1:30>"));
}
...
TEST_CASE("java parsersupports java 14 switch expression") {
  ...
  REQUIRE(utility::containsElement<std::wstring>(client->usages,
                                                 L"void foo.Foo.foo() -> foo.Foo.FruitType.PEAR <12:9 12:12>"));
}
