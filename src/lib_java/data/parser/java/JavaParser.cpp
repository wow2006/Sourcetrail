...
JavaParser::JavaParser(std::shared_ptr<ParserClient> client, std::shared_ptr<IndexerStateInfo> indexerStateInfo)
  ...
  if (factory) {
    ...
    methods.push_back(
        {"recordSymbolWithLocation", "(ILjava/lang/String;IIIIIII)V", (void*)&JavaParser::RecordSymbolWithLocation});
    methods.push_back({"recordSymbolWithLocationAndScope", "(ILjava/lang/String;IIIIIIIIIII)V",
                       (void*)&JavaParser::RecordSymbolWithLocationAndScope});
    methods.push_back({"recordSymbolWithLocationAndScopeAndSignature", "(ILjava/lang/String;IIIIIIIIIIIIIII)V",
                       (void*)&JavaParser::RecordSymbolWithLocationAndScopeAndSignature});
    methods.push_back(
        {"recordReference", "(IILjava/lang/String;Ljava/lang/String;IIII)V", (void*)&JavaParser::RecordReference});
    methods.push_back(
        {"recordQualifierLocation", "(ILjava/lang/String;IIII)V", (void*)&JavaParser::RecordQualifierLocation});
...
JavaParser::~JavaParser() { s_parsers.erase(m_id); }
...
void JavaParser::buildIndex(std::shared_ptr<IndexerCommandJava> indexerCommand) {
  ...
  buildIndex(indexerCommand->getSourceFilePath(), indexerCommand->getLanguageStandard(), classPath,
...
void JavaParser::buildIndex(const FilePath& sourceFilePath, const std::wstring& languageStandard,
                            const std::string& classPath, std::shared_ptr<TextAccess> textAccess) {
  if (m_javaEnvironment) {
    ...
    m_javaEnvironment->callStaticVoidMethod("com/sourcetrail/JavaIndexer", "processFile", m_id, m_currentFilePath.str(),
                                            fileContent, utility::encodeToUtf8(languageStandard), classPath, verbose);
  }
}
...
bool JavaParser::doGetInterrupted() { return m_indexerStateInfo->indexingInterrupted; }
...
void JavaParser::doRecordSymbolWithLocation(jstring jSymbolName, jint jSymbolKind, jint beginLine, jint beginColumn,
                                            jint endLine, jint endColumn, jint jAccess, jint jDefinitionKind) {
  Id symbolId = getOrCreateSymbolId(jSymbolName);
  m_client->recordSymbolKind(symbolId, intToSymbolKind(jSymbolKind));
  m_client->recordLocation(symbolId, ParseLocation(m_currentFileId, beginLine, beginColumn, endLine, endColumn),
                           ParseLocationType::TOKEN);
  m_client->recordAccessKind(symbolId, intToAccessKind(jAccess));
  m_client->recordDefinitionKind(symbolId, intToDefinitionKind(jDefinitionKind));
}

void JavaParser::doRecordSymbolWithLocationAndScope(jstring jSymbolName, jint jSymbolKind, jint beginLine,
                                                    jint beginColumn, jint endLine, jint endColumn, jint scopeBeginLine,
                                                    jint scopeBeginColumn, jint scopeEndLine, jint scopeEndColumn,
  ...
  m_client->recordLocation(
      symbolId, ParseLocation(m_currentFileId, scopeBeginLine, scopeBeginColumn, scopeEndLine, scopeEndColumn),
...
void JavaParser::doRecordSymbolWithLocationAndScopeAndSignature(
    jstring jSymbolName, jint jSymbolKind, jint beginLine, jint beginColumn, jint endLine, jint endColumn,
    jint scopeBeginLine, jint scopeBeginColumn, jint scopeEndLine, jint scopeEndColumn, jint signatureBeginLine,
    jint signatureBeginColumn, jint signatureEndLine, jint signatureEndColumn, jint jAccess, jint jDefinitionKind) {
  Id symbolId = getOrCreateSymbolId(jSymbolName);
  m_client->recordSymbolKind(symbolId, intToSymbolKind(jSymbolKind));
  m_client->recordLocation(symbolId, ParseLocation(m_currentFileId, beginLine, beginColumn, endLine, endColumn),
                           ParseLocationType::TOKEN);
  ...
  m_client->recordLocation(
      symbolId,
      ParseLocation(m_currentFileId, signatureBeginLine, signatureBeginColumn, signatureEndLine, signatureEndColumn),
      ParseLocationType::SIGNATURE);
  m_client->recordAccessKind(symbolId, intToAccessKind(jAccess));
  m_client->recordDefinitionKind(symbolId, intToDefinitionKind(jDefinitionKind));
}

void JavaParser::doRecordReference(jint jReferenceKind, jstring jReferencedName, jstring jContextName, jint beginLine,
                                   jint beginColumn, jint endLine, jint endColumn) {
  m_client->recordReference(intToReferenceKind(jReferenceKind), getOrCreateSymbolId(jReferencedName),
                            getOrCreateSymbolId(jContextName),
                            ParseLocation(m_currentFileId, beginLine, beginColumn, endLine, endColumn));
}

void JavaParser::doRecordQualifierLocation(jstring jQualifierName, jint beginLine, jint beginColumn, jint endLine,
                                           jint endColumn) {
...
void JavaParser::doRecordLocalSymbol(jstring jSymbolName, jint beginLine, jint beginColumn, jint endLine,
                                     jint endColumn) {
...
void JavaParser::doRecordComment(jint beginLine, jint beginColumn, jint endLine, jint endColumn) {
  m_client->recordComment(ParseLocation(m_currentFileId, beginLine, beginColumn, endLine, endColumn));
}

void JavaParser::doRecordError(jstring jMessage, jint jFatal, jint jIndexed, jint beginLine, jint beginColumn,
                               jint endLine, jint endColumn) {
  bool fatal = jFatal;
  bool indexed = jIndexed;

  m_client->recordError(utility::decodeFromUtf8(m_javaEnvironment->toStdString(jMessage)), fatal, indexed, FilePath(),
