...
JavaEnvironment::~JavaEnvironment() { JavaEnvironmentFactory::getInstance()->unregisterEnvironment(); }
...
bool JavaEnvironment::callStaticVoidMethod(std::string className, std::string methodName, const std::string& arg1,
                                           const std::string& arg2, const std::string& arg3) {
  jclass javaClass = getJavaClass(className);
  jmethodID javaMethodId =
      getJavaStaticMethod(javaClass, methodName, "(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V");
  if (javaMethodId != nullptr) {
...
bool JavaEnvironment::callStaticVoidMethod(std::string className, std::string methodName, int arg1, std::string arg2,
                                           std::string arg3, std::string arg4, std::string arg5, int arg6) {
  jclass javaClass = getJavaClass(className);
  jmethodID javaMethodId = getJavaStaticMethod(
      javaClass, methodName, "(ILjava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;I)V");
  if (javaMethodId != nullptr) {
    jint jarg1 = arg1;
    jstring jarg2 = m_env->NewStringUTF(arg2.c_str());
    jstring jarg3 = m_env->NewStringUTF(arg3.c_str());
...
bool JavaEnvironment::callStaticStringMethod(std::string className, std::string methodName, std::string& ret,
...
bool JavaEnvironment::callStaticStringMethod(std::string className, std::string methodName, std::string& ret,
  ...
  jclass javaClass = getJavaClass(className);
  jmethodID javaMethodId =
      getJavaStaticMethod(javaClass, methodName, "(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;");
  if (javaMethodId != nullptr) {
    jstring jarg1 = m_env->NewStringUTF(arg1.c_str());
    jstring jarg2 = m_env->NewStringUTF(arg2.c_str());
...
jstring JavaEnvironment::toJString(std::string s) { return m_env->NewStringUTF(s.c_str()); }
...
jmethodID JavaEnvironment::getJavaStaticMethod(const std::string& className, const std::string& methodName,
                                               const std::string& methodSignature) {
  return getJavaStaticMethod(getJavaClass(className), methodName, methodSignature);
}

jmethodID JavaEnvironment::getJavaStaticMethod(jclass javaClass, const std::string& methodName,
                                               const std::string& methodSignature) {
  if (javaClass != nullptr) {
