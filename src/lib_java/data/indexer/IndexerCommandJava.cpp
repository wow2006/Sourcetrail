...
IndexerCommandType IndexerCommandJava::getStaticIndexerCommandType() { return INDEXER_COMMAND_JAVA; }

IndexerCommandJava::IndexerCommandJava(const FilePath& sourceFilePath, const std::wstring& languageStandard,
...
IndexerCommandType IndexerCommandJava::getIndexerCommandType() const { return getStaticIndexerCommandType(); }
...
std::wstring IndexerCommandJava::getLanguageStandard() const { return m_languageStandard; }

void IndexerCommandJava::setClassPath(std::vector<FilePath> classPath) { m_classPath = classPath; }

std::vector<FilePath> IndexerCommandJava::getClassPath() const { return m_classPath; }
