...
IndexerCommandType IndexerCommandCustom::getStaticIndexerCommandType() { return INDEXER_COMMAND_CUSTOM; }

IndexerCommandCustom::IndexerCommandCustom(const std::wstring& command, const std::vector<std::wstring>& arguments,
                                           const FilePath& projectFilePath, const FilePath& databaseFilePath,
                                           const std::wstring& databaseVersion, const FilePath& sourceFilePath,
                                           bool runInParallel)
...
IndexerCommandCustom::IndexerCommandCustom(IndexerCommandType type, const std::wstring& command,
                                           const std::vector<std::wstring>& arguments, const FilePath& projectFilePath,
                                           const FilePath& databaseFilePath, const std::wstring& databaseVersion,
                                           const FilePath& sourceFilePath, bool runInParallel)
    : IndexerCommand(sourceFilePath),
      m_type(type),
      m_command(command),
      m_arguments(arguments),
...
IndexerCommandType IndexerCommandCustom::getIndexerCommandType() const { return m_type; }
...
FilePath IndexerCommandCustom::getDatabaseFilePath() const { return m_databaseFilePath; }

void IndexerCommandCustom::setDatabaseFilePath(const FilePath& databaseFilePath) {
  m_databaseFilePath = databaseFilePath;
}

std::wstring IndexerCommandCustom::getCommand() const { return replaceVariables(m_command); }
...
bool IndexerCommandCustom::getRunInParallel() const { return m_runInParallel; }
