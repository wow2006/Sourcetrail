...
const std::wstring& NameHierarchy::getDelimiter() const { return m_delimiter; }

void NameHierarchy::setDelimiter(std::wstring delimiter) { m_delimiter = std::move(delimiter); }
...
NameHierarchy::NameHierarchy(std::wstring name, std::wstring delimiter) : m_delimiter(std::move(delimiter)) {
  push(std::move(name));
}
...
void NameHierarchy::push(NameElement element) { m_elements.emplace_back(std::move(element)); }

void NameHierarchy::push(std::wstring name) { m_elements.emplace_back(std::move(name)); }

void NameHierarchy::pop() { m_elements.pop_back(); }

NameElement& NameHierarchy::back() { return m_elements.back(); }

const NameElement& NameHierarchy::back() const { return m_elements.back(); }

NameElement& NameHierarchy::operator[](size_t pos) { return m_elements[pos]; }

const NameElement& NameHierarchy::operator[](size_t pos) const { return m_elements[pos]; }
...
size_t NameHierarchy::size() const { return m_elements.size(); }
