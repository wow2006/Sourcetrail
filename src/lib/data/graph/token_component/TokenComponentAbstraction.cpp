...
TokenComponentAbstraction::TokenComponentAbstraction(AbstractionType abstraction) : m_abstraction(abstraction) {}
...
TokenComponentAbstraction::AbstractionType TokenComponentAbstraction::getAbstraction() const { return m_abstraction; }
