...
SourceLocationFile::SourceLocationFile(const FilePath& filePath, const std::wstring& language, bool isWhole,
...
const FilePath& SourceLocationFile::getFilePath() const { return m_filePath; }

void SourceLocationFile::setLanguage(const std::wstring& language) { m_language = language; }

const std::wstring& SourceLocationFile::getLanguage() const { return m_language; }

void SourceLocationFile::setIsWhole(bool isWhole) { m_isWhole = isWhole; }

bool SourceLocationFile::isWhole() const { return m_isWhole; }

void SourceLocationFile::setIsComplete(bool isComplete) { m_isComplete = isComplete; }

bool SourceLocationFile::isComplete() const { return m_isComplete; }

void SourceLocationFile::setIsIndexed(bool isIndexed) { m_isIndexed = isIndexed; }

bool SourceLocationFile::isIndexed() const { return m_isIndexed; }

const std::multiset<std::shared_ptr<SourceLocation>, SourceLocationFile::LocationComp>&
SourceLocationFile::getSourceLocations() const {
  return m_locations;
}

size_t SourceLocationFile::getSourceLocationCount() const { return m_locationIndex.size(); }
...
SourceLocation* SourceLocationFile::addSourceLocation(LocationType type, Id locationId, std::vector<Id> tokenIds,
