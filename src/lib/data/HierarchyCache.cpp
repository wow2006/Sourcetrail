...
void HierarchyCache::HierarchyNode::addChildIds(std::vector<Id>* nodeIds,
                                                std::vector<Id>* edgeIds) const {
  for(const HierarchyNode* child: m_children) {
...
void HierarchyCache::HierarchyNode::addNonImplicitChildIds(std::vector<Id>* nodeIds,
                                                           std::vector<Id>* edgeIds) const {
  for(const HierarchyNode* child: m_children) {
    if(!child->isImplicit()) {
      nodeIds->push_back(child->getNodeId());
...
void HierarchyCache::HierarchyNode::addChildIdsRecursive(std::set<Id>* nodeIds,
                                                         std::set<Id>* edgeIds) const {
  for(const HierarchyNode* child: m_children) {
...
void HierarchyCache::addAllVisibleParentIdsForNodeId(Id nodeId,
                                                     std::set<Id>* nodeIds,
                                                     std::set<Id>* edgeIds) const {
...
void HierarchyCache::addAllChildIdsForNodeId(Id nodeId,
                                             std::set<Id>* nodeIds,
                                             std::set<Id>* edgeIds) const {
  HierarchyNode* node = getNode(nodeId);
...
void HierarchyCache::addFirstChildIdsForNodeId(Id nodeId,
