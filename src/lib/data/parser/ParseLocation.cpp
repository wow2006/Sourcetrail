...
ParseLocation::ParseLocation(Id fileId, size_t startLineNumber, size_t startColumnNumber, size_t endLineNumber,
...
bool ParseLocation::isValid() const { return fileId; }
