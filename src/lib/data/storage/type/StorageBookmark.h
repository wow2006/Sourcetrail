...
struct StorageBookmarkData {
  ...
  StorageBookmarkData(const std::wstring& name, const std::wstring& comment, const std::string& timestamp,
                      const Id categoryId)
...
struct StorageBookmark : public StorageBookmarkData {
  ...
  StorageBookmark(Id id, const std::wstring& name, const std::wstring& comment, const std::string& timestamp,
                  const Id categoryId)
