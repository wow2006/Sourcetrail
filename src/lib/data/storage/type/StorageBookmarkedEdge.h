...
struct StorageBookmarkedEdgeData {
  ...
  StorageBookmarkedEdgeData(Id bookmarkId, const std::wstring& serializedSourceNodeName,
                            const std::wstring& serializedTargetNodeName, int edgeType, bool sourceNodeActive)
...
struct StorageBookmarkedEdge : public StorageBookmarkedEdgeData {
  ...
  StorageBookmarkedEdge(Id id, const StorageBookmarkedEdgeData& data) : StorageBookmarkedEdgeData(data), id(id) {}

  StorageBookmarkedEdge(Id id, Id bookmarkId, const std::wstring& serializedSourceNodeName,
                        const std::wstring& serializedTargetNodeName, int edgeType, bool sourceNodeActive)
      : StorageBookmarkedEdgeData(bookmarkId, serializedSourceNodeName, serializedTargetNodeName, edgeType,
                                  sourceNodeActive),
        id(id) {}
