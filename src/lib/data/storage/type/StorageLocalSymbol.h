...
struct StorageLocalSymbolData {
  ...
  bool operator<(const StorageLocalSymbolData& other) const { return name < other.name; }
...
struct StorageLocalSymbol : public StorageLocalSymbolData {
  ...
  StorageLocalSymbol(Id id, const StorageLocalSymbolData& data) : StorageLocalSymbolData(data), id(id) {}
