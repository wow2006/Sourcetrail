...
StorageAccessProxy::StorageAccessProxy() = default;
...
#define DEF_GETTER_4(_METHOD_NAME_,                                                                \
                     _PARAM_1_TYPE_,                                                               \
                     _PARAM_2_TYPE_,                                                               \
                     _PARAM_3_TYPE_,                                                               \
                     _PARAM_4_TYPE_,                                                               \
...
#define DEF_GETTER_5(_METHOD_NAME_,                                                                  \
                     _PARAM_1_TYPE_,                                                                 \
                     _PARAM_2_TYPE_,                                                                 \
                     _PARAM_3_TYPE_,                                                                 \
                     _PARAM_4_TYPE_,                                                                 \
...
#define DEF_GETTER_6(_METHOD_NAME_,                                                                \
                     _PARAM_1_TYPE_,                                                               \
                     _PARAM_2_TYPE_,                                                               \
                     _PARAM_3_TYPE_,                                                               \
                     _PARAM_4_TYPE_,                                                               \
                     ...
                     _DEFAULT_VALUE_)                                                              \
  UNWRAP(_RETURN_TYPE_)                                                                            \
  StorageAccessProxy::_METHOD_NAME_(_PARAM_1_TYPE_ p1,                                             \
                                    _PARAM_2_TYPE_ p2,                                             \
                                    _PARAM_3_TYPE_ p3,                                             \
                                    _PARAM_4_TYPE_ p4,                                             \
                                    _PARAM_5_TYPE_ p5,                                             \
...
#define DEF_GETTER_7(_METHOD_NAME_,                                                                \
                     _PARAM_1_TYPE_,                                                               \
                     _PARAM_2_TYPE_,                                                               \
                     _PARAM_3_TYPE_,                                                               \
                     _PARAM_4_TYPE_,                                                               \
...
DEF_GETTER_2(getFullTextSearchLocations,
             const std::wstring&,
             bool,
             std::shared_ptr<SourceLocationCollection>,
             std::make_shared<SourceLocationCollection>())
DEF_GETTER_3(getAutocompletionMatches,
             const std::wstring&,
             NodeTypeSet,
             bool,
             std::vector<SearchMatch>,
             std::vector<SearchMatch>())
DEF_GETTER_1(getSearchMatchesForTokenIds,
             const std::vector<Id>&,
             std::vector<SearchMatch>,
             std::vector<SearchMatch>())
...
DEF_GETTER_3(getGraphForActiveTokenIds,
             const std::vector<Id>&,
             const std::vector<Id>&,
             bool*,
...
DEF_GETTER_1(getSourceLocationsForTokenIds,
             const std::vector<Id>&,
             std::shared_ptr<SourceLocationCollection>,
             std::make_shared<SourceLocationCollection>())
DEF_GETTER_1(getSourceLocationsForLocationIds,
             const std::vector<Id>&,
             std::shared_ptr<SourceLocationCollection>,
             std::make_shared<SourceLocationCollection>())
...
DEF_GETTER_2(getTooltipInfoForSourceLocationIdsAndLocalSymbolIds,
             const std::vector<Id>&,
             const std::vector<Id>&,
             TooltipInfo,
             TooltipInfo())
