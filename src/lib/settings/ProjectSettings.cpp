...
SettingsMigrator ProjectSettings::getMigrations() const {
...

  {
    ...
    migrator.addMigration(2, std::make_shared<SettingsMigrationMoveKey>("source/source_paths/source_path",
                                                                        sourceGroupKey + "/source_paths/source_path"));
    ...
    migrator.addMigration(2,
                          std::make_shared<SettingsMigrationMoveKey>("source/compiler_flags/compiler_flag",
    ...
    migrator.addMigration(2,
                          std::make_shared<SettingsMigrationMoveKey>("source/maven/dependencies_directory",
                                                                     sourceGroupKey + "/maven/dependencies_directory"));
    migrator.addMigration(2, std::make_shared<SettingsMigrationMoveKey>("source/maven/should_index_tests",
                                                                        sourceGroupKey + "/maven/should_index_tests"));
        ...
        3, std::make_shared<SettingsMigrationLambda>([=](const SettingsMigration* migration, Settings* settings) {
          ...
          if (language == "Java") {
            const std::string mavenProjectFilePath =
                migration->getValueFromSettings<std::string>(settings, sourceGroupKey + "/maven/project_file_path", "");
