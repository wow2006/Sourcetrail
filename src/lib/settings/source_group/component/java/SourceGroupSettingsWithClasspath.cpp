...
std::vector<FilePath> SourceGroupSettingsWithClasspath::getClasspath() const { return m_classpath; }
...
void SourceGroupSettingsWithClasspath::setClasspath(const std::vector<FilePath>& classpath) { m_classpath = classpath; }

bool SourceGroupSettingsWithClasspath::getUseJreSystemLibrary() const { return m_useJreSystemLibrary; }
