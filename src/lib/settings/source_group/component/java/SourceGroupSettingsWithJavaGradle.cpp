...
FilePath SourceGroupSettingsWithJavaGradle::getGradleProjectFilePath() const { return m_gradleProjectFilePath; }

FilePath SourceGroupSettingsWithJavaGradle::getGradleProjectFilePathExpandedAndAbsolute() const {
  return utility::getExpandedAndAbsolutePath(getGradleProjectFilePath(),
...
bool SourceGroupSettingsWithJavaGradle::getShouldIndexGradleTests() const { return m_shouldIndexGradleTests; }

void SourceGroupSettingsWithJavaGradle::setShouldIndexGradleTests(bool value) { m_shouldIndexGradleTests = value; }
...
bool SourceGroupSettingsWithJavaGradle::equals(const SourceGroupSettingsBase* other) const {
  ...
  return (otherPtr && m_gradleProjectFilePath == otherPtr->m_gradleProjectFilePath &&
