...
const std::wstring& SourceGroupSettingsWithCustomCommand::getCustomCommand() const { return m_customCommand; }

void SourceGroupSettingsWithCustomCommand::setCustomCommand(const std::wstring& customCommand) {
  m_customCommand = customCommand;
}

bool SourceGroupSettingsWithCustomCommand::getRunInParallel() const { return m_runInParallel; }

void SourceGroupSettingsWithCustomCommand::setRunInParallel(bool runInParallel) { m_runInParallel = runInParallel; }
