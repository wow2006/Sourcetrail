...
FilePath SourceGroupSettingsWithCxxPchOptions::getPchInputFilePath() const { return m_pchInputFilePath; }
...
bool SourceGroupSettingsWithCxxPchOptions::equals(const SourceGroupSettingsBase* other) const {
  ...
  return (otherPtr && m_pchInputFilePath == otherPtr->m_pchInputFilePath &&
...
bool SourceGroupSettingsWithCxxPchOptions::getUseCompilerFlags() const { return m_useCompilerFlags; }

void SourceGroupSettingsWithCxxPchOptions::setUseCompilerFlags(bool useCompilerFlags) {
  m_useCompilerFlags = useCompilerFlags;
}

std::vector<std::wstring> SourceGroupSettingsWithCxxPchOptions::getPchFlags() const { return m_pchFlags; }
