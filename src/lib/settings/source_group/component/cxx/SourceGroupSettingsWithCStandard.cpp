...
void SourceGroupSettingsWithCStandard::setCStandard(const std::wstring& standard) { m_cStandard = standard; }
...
std::vector<std::wstring> SourceGroupSettingsWithCStandard::getAvailableCStandards() const {
  ...
  return {L"c2x",   L"gnu2x",        L"c17",          L"gnu17", L"iso9899:2017", L"c11",
          L"gnu11", L"iso9899:2011", L"c99",          L"gnu99", L"iso9899:1999", L"iso9899:199409",
          L"c90",   L"gnu90",        L"iso9899:1990", L"c89",   L"gnu89"};
}
...
std::wstring SourceGroupSettingsWithCStandard::getDefaultCStandard() const { return getDefaultCStandardStatic(); }
