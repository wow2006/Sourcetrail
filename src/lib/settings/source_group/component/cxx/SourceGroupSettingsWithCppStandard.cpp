...
void SourceGroupSettingsWithCppStandard::setCppStandard(const std::wstring& standard) { m_cppStandard = standard; }
...
std::vector<std::wstring> SourceGroupSettingsWithCppStandard::getAvailableCppStandards() const {
  ...
  return {L"c++2a", L"gnu++2a", L"c++17", L"gnu++17", L"c++14", L"gnu++14",
          L"c++11", L"gnu++11", L"c++03", L"gnu++03", L"c++98", L"gnu++98"};
}
...
std::wstring SourceGroupSettingsWithCppStandard::getDefaultCppStandard() const { return getDefaultCppStandardStatic(); }
