...
void SourceGroupSettingsWithCppStandard::load(const utility::ConfigManagerigManager* config,
                                              const std::string& key) {
  setCppStandard(config->getValueOrDefault<std::wstring>(key + "/cpp_standard", L""));
}

void SourceGroupSettingsWithCppStandard::save(utility::ConfigManagerigManager* config,
                                              const std::string& key) {
