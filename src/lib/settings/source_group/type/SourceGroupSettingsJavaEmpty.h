...
class SourceGroupSettingsJavaEmpty
    : public SourceGroupSettingsWithComponents<
          SourceGroupSettingsWithClasspath, SourceGroupSettingsWithExcludeFilters, SourceGroupSettingsWithJavaStandard,
          SourceGroupSettingsWithSourceExtensionsJava, SourceGroupSettingsWithSourcePaths> {
 public:
