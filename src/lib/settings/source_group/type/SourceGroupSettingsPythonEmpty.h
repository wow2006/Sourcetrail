...
class SourceGroupSettingsPythonEmpty
    : public SourceGroupSettingsWithComponents<
          SourceGroupSettingsWithExcludeFilters, SourceGroupSettingsWithPythonEnvironmentPath,
          SourceGroupSettingsWithSourceExtensionsPython, SourceGroupSettingsWithSourcePaths> {
 public:
