...
CommandlineCommand::CommandlineCommand(const std::string& name, const std::string& description,
                                       CommandLineParser* parser)
    : m_name(name), m_description(description), m_parser(parser) {}

CommandlineCommand::~CommandlineCommand() = default;

const std::string& CommandlineCommand::name() { return m_name; }

const std::string& CommandlineCommand::description() { return m_description; }
