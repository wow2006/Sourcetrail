...
std::wstring FilePathFilter::wstr() const { return m_filterString; }

bool FilePathFilter::isMatching(const FilePath& filePath) const { return isMatching(filePath.wstr()); }

bool FilePathFilter::isMatching(const std::wstring& fileStr) const { return std::regex_match(fileStr, m_filterRegex); }
