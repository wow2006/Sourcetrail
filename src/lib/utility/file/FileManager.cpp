...
void FileManager::update(const std::vector<FilePath>& sourcePaths, const std::vector<FilePathFilter>& excludeFilters,
...
std::vector<FilePath> FileManager::getSourcePaths() const { return m_sourcePaths; }
...
std::set<FilePath> FileManager::getAllSourceFilePaths() const { return m_allSourceFilePaths; }
