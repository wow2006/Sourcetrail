...
class ScopedTrace {
 public:
  ScopedTrace(const std::string& eventName, const std::string& fileName, int lineNumber,
...
template <typename TracerType>
ScopedTrace<TracerType>::ScopedTrace(const std::string& eventName, const std::string& fileName, int lineNumber,
                                     const std::string& functionName) {
...
#else
#define TRACE(__name__) ScopedTrace<Tracer> __trace__(std::string(__name__), __FILE__, __LINE__, __FUNCTION__)
