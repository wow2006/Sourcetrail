...
class MessageBookmarkButtonState : public Message<MessageBookmarkButtonState> {
 public:
  ...
  static const std::string getStaticType() { return "MessageBookmarkButtonState"; }

  MessageBookmarkButtonState(Id schedulerId, ButtonState state) : state(state) { setSchedulerId(schedulerId); }
