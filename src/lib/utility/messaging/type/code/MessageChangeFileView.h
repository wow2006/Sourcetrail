...
class MessageChangeFileView : public Message<MessageChangeFileView> {
 public:
  ...
  MessageChangeFileView(const FilePath& filePath, FileState state, ViewMode viewMode, CodeScrollParams scrollParams,
  ...
  static const std::string getStaticType() { return "MessageChangeFileView"; }
