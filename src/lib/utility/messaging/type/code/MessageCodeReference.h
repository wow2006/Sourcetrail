...
class MessageCodeReference : public Message<MessageCodeReference> {
 public:
  ...
  MessageCodeReference(ReferenceType type, bool localReference) : type(type), localReference(localReference) {
    setSchedulerId(TabId::currentTab());
  }

  static const std::string getStaticType() { return "MessageCodeReference"; }
