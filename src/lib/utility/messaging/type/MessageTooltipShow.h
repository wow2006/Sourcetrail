...
class MessageTooltipShow : public Message<MessageTooltipShow> {
 public:
  ...
  MessageTooltipShow(const std::vector<Id>& sourceLocationIds, const std::vector<Id>& localSymbolIds,
  ...
  static const std::string getStaticType() { return "MessageTooltipShow"; }
