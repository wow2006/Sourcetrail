...
Tab::~Tab() { m_componentManager.teardownTab(m_screenSearchSender); }

Id Tab::getSchedulerId() const { return m_tabId; }
...
void Tab::addView(View* view) { m_views.push_back(view); }
...
void Tab::handleMessage(MessageRefreshUI* message) { m_componentManager.refreshViews(); }
