...
void ComponentManager::setupMain(ViewLayout* viewLayout, Id appId) {
  ...
  std::shared_ptr<RefreshView> refreshView = m_componentFactory.getViewFactory()->createRefreshView(
      compositeView.get());
  ...
  std::shared_ptr<Component> screenSearchComponent = m_componentFactory.createScreenSearchComponent(
      viewLayout);
  ...
  for(DialogView::UseCase useCase: {DialogView::UseCase::GENERAL,
                                    DialogView::UseCase::INDEXING,
                                    DialogView::UseCase::PROJECT_SETUP}) {
    m_dialogViews.emplace(useCase,
...
void ComponentManager::setupTab(ViewLayout* viewLayout,
                                Id tabId,
