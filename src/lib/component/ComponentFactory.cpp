...
const ViewFactory* ComponentFactory::getViewFactory() const { return m_viewFactory; }

StorageAccess* ComponentFactory::getStorageAccess() const { return m_storageAccess; }
...
std::shared_ptr<Component> ComponentFactory::createTabsComponent(ViewLayout* viewLayout,
                                                                 ScreenSearchSender* screenSearchSender) {
  std::shared_ptr<TabsView> view = m_viewFactory->createTabsView(viewLayout);
  std::shared_ptr<Controller> controller =
      std::make_shared<TabsController>(viewLayout, m_viewFactory, m_storageAccess, screenSearchSender);
