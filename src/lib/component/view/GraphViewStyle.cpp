...
GraphViewStyle::NodeMargins GraphViewStyle::getMarginsForDataNode(NodeType::StyleType type,
                                                                  bool hasIcon,
                                                                  bool hasChildren) {
  NodeMargins margins;
  margins.spacingX = 6;
...
GraphViewStyle::NodeStyle GraphViewStyle::getStyleForNodeType(NodeType type,
                                                              bool defined,
                                                              bool isActive,
                                                              bool isFocused,
                                                              bool isCoFocused,
                                                              bool hasChildren,
                                                              bool hasQualifier) {
  return getStyleForNodeType(type.getNodeStyle(),
...
const GraphViewStyle::NodeColor& GraphViewStyle::getNodeColor(const std::string& typeStr,
                                                              bool highlight) {
