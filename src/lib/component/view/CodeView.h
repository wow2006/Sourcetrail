...
class CodeView : public View, public ScreenSearchResponder {
 public:
  ...
  virtual void showSnippets(const std::vector<CodeFileParams>& files, const CodeParams& params,
                            const CodeScrollParams& scrollParams) = 0;

  virtual void showSingleFile(const CodeFileParams& file, const CodeParams& params,
                              const CodeScrollParams& scrollParams) = 0;
