...
TabsView* TabsController::getView() const { return Controller::getView<TabsView>(); }
...
void TabsController::handleMessage(MessageTabClose* message) { getView()->closeTab(); }
...
void TabsController::handleMessage(MessageTabSelect* message) { getView()->selectTab(message->next); }
