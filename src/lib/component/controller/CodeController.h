...
class CodeController : public Controller,
 ...
 private:
  ...
  std::vector<CodeFileParams> getFilesForActiveSourceLocations(const SourceLocationCollection* collection,
  ...
  CodeSnippetParams getSnippetParamsForWholeFile(std::shared_ptr<SourceLocationFile> locationFile,
  ...
  std::shared_ptr<SnippetMerger> buildMergerHierarchy(const SourceLocation* location,
  ...
  const SourceLocation* getSourceLocationOfParentScope(size_t lineNumber,
