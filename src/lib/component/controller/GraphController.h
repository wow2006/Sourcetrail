...
class GraphController : public Controller,
 ...
 private:
  ...
  void bundleNodes();
  void bundleNodesAndEdgesMatching(std::function<bool(const DummyNode::BundleInfo&, const Node*)> matcher, size_t count,
                                   bool countConnectedNodes, const std::wstring& name);
