...
void ScreenSearchController::handleActivation(const MessageActivateBase* message) { clearMatches(); }

void ScreenSearchController::handleMessage(MessageActivateLocalSymbols* message) { clearMatches(); }

void ScreenSearchController::handleMessage(MessageActivateTrailEdge* message) { clearMatches(); }

void ScreenSearchController::handleMessage(MessageChangeFileView* message) { clearMatches(); }

void ScreenSearchController::handleMessage(MessageCodeShowDefinition* message) { clearMatches(); }

void ScreenSearchController::handleMessage(MessageDeactivateEdge* message) { clearMatches(); }

void ScreenSearchController::handleMessage(MessageGraphNodeBundleSplit* message) { clearMatches(); }

void ScreenSearchController::handleMessage(MessageGraphNodeExpand* message) { clearMatches(); }

void ScreenSearchController::handleMessage(MessageGraphNodeHide* message) { clearMatches(); }
