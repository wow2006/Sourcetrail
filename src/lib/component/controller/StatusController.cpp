...
StatusController::StatusController() { m_statusFilter = ApplicationSettings::getInstance()->getStatusFilter(); }

StatusController::~StatusController() {}

StatusView* StatusController::getView() const { return Controller::getView<StatusView>(); }
...
void StatusController::handleMessage(MessageShowStatus* message) { getView()->showDockWidget(); }
