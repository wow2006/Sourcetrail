...
class NetworkProtocolHelper {
 public:
  ...
  enum MESSAGE_TYPE { UNKNOWN = 0, SET_ACTIVE_TOKEN, CREATE_PROJECT, CREATE_CDB_MESSAGE, PING };
  ...
  static std::wstring buildSetIDECursorMessage(const FilePath& fileLocation, const unsigned int row,
