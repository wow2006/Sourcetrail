...
std::string Target::getXmlElementName() { return "Target"; }
...
std::wstring Target::getTitle() const { return m_title; }

std::shared_ptr<const Compiler> Target::getCompiler() const { return m_compiler; }
