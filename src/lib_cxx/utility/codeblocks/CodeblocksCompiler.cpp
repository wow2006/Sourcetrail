...
std::string Compiler::getXmlElementName() { return "Compiler"; }
...
const std::vector<std::wstring>& Compiler::getOptions() const { return m_options; }

const std::vector<std::wstring>& Compiler::getDirectories() const { return m_directories; }
}  // namespace Codeblocks
