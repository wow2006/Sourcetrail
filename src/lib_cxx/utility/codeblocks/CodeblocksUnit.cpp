...
std::string Unit::getXmlElementName() { return "Unit"; }
...
CompilerVarType Unit::getCompilerVar() const { return m_compilerVar; }

bool Unit::getCompile() const { return m_compile; }

std::set<std::wstring> Unit::getTargetNames() const { return m_targetNames; }
