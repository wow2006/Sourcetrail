...
CanonicalFilePathCache* CxxNameResolver::getCanonicalFilePathCache() const { return m_canonicalFilePathCache; }

const std::vector<const clang::Decl*>& CxxNameResolver::getIgnoredContextDecls() const { return m_ignoredContextDecls; }
