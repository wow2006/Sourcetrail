...
void PreprocessorCallbacks::FileChanged(clang::SourceLocation location,
...
void PreprocessorCallbacks::InclusionDirective(clang::SourceLocation /*hashLocation*/,
  ...
  if(m_currentFileSymbolId && fileEntry) {
    ...
    m_client->recordReference(REFERENCE_INCLUDE,
...
void PreprocessorCallbacks::Defined(const clang::Token& macroNameToken,
                                    const clang::MacroDefinition& /*macroDefinition*/,
                                    clang::SourceRange /*range*/) {
  onMacroUsage(macroNameToken);
}

void PreprocessorCallbacks::Ifdef(clang::SourceLocation /*location*/,
                                  const clang::Token& macroNameToken,
                                  const clang::MacroDefinition& /*macroDefinition*/) {
  onMacroUsage(macroNameToken);
}
void PreprocessorCallbacks::Ifndef(clang::SourceLocation /*location*/,
                                   const clang::Token& macroNameToken,
                                   const clang::MacroDefinition& /*macroDefinition*/) {
  onMacroUsage(macroNameToken);
}
