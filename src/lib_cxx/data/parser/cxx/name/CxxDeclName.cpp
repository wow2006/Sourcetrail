...
const std::wstring& CxxDeclName::getName() const { return m_name; }

const std::vector<std::wstring>& CxxDeclName::getTemplateParameterNames() const { return m_templateParameterNames; }
