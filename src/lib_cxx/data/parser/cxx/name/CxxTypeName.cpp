...
std::unique_ptr<CxxTypeName> CxxTypeName::getUnsolved() { return std::make_unique<CxxTypeName>(L"unsolved-type"); }
...
void CxxTypeName::addModifier(Modifier modifier) { m_modifiers.emplace_back(std::move(modifier)); }
