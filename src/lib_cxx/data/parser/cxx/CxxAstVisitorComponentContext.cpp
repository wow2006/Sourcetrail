...
void CxxAstVisitorComponentContext::beginTraverseDecl(clang::Decl* d) {
  ...
  if (d && clang::isa<clang::NamedDecl>(d) && !clang::isa<clang::ParmVarDecl>(d) &&     // no parameter
...
void CxxAstVisitorComponentContext::endTraverseDecl(clang::Decl* d) { m_contextStack.pop_back(); }
...
void CxxAstVisitorComponentContext::endTraverseTypeLoc(const clang::TypeLoc& tl) { m_contextStack.pop_back(); }
...
void CxxAstVisitorComponentContext::endTraverseLambdaExpr(clang::LambdaExpr* s) { m_contextStack.pop_back(); }
