...
void CxxAstVisitorComponentTypeRefKind::endTraverseCXXBaseSpecifier() { m_stateKindStack.pop_back(); }

void CxxAstVisitorComponentTypeRefKind::beginTraverseTemplateDefaultArgumentLoc() {
  m_stateKindStack.push_back(STATE_USAGE);
}

void CxxAstVisitorComponentTypeRefKind::endTraverseTemplateDefaultArgumentLoc() { m_stateKindStack.pop_back(); }
