...
std::shared_ptr<SourceGroup> SourceGroupFactoryModuleCxx::createSourceGroup(
  ...
  } else if (std::shared_ptr<SourceGroupSettingsCxxCodeblocks> cxxSettings =
  ...
  } else if (std::shared_ptr<SourceGroupSettingsCEmpty> cxxSettings =
  ...
  } else if (std::shared_ptr<SourceGroupSettingsCppEmpty> cxxSettings =
