...
std::set<FilePath> SourceGroupCxxCodeblocks::filterToContainedFilePaths(const std::set<FilePath>& filePaths) const {
  return SourceGroup::filterToContainedFilePaths(filePaths, getAllSourceFilePaths(),
...
std::set<FilePath> SourceGroupCxxCodeblocks::getAllSourceFilePaths() const {
  ...
  if (std::shared_ptr<Codeblocks::Project> project =
          Codeblocks::Project::load(m_settings->getCodeblocksProjectPathExpandedAndAbsolute())) {
...
std::shared_ptr<SourceGroupSettings> SourceGroupCxxCodeblocks::getSourceGroupSettings() { return m_settings; }
